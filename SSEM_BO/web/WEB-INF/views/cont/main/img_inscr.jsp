...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="frm" id="frm" action="/ssemadmin/cont/main/img_inscr.do" method="post" enctype="multipart/form-data">
        <table>
            <colgroup>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span>(파일형식 : jpg, jpeg, png, gif / 사이즈 : <span class="co_red">1920*600</span>)</span>
                </td>
            </tr>
            <tr>
