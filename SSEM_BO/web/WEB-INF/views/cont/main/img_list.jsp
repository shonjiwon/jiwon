...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/main/img_list.do">
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <tbody>
            <form name="ordfrm" id="ordfrm" method="post" action="/ssemadmin/cont/main/img_ord.do" enctype="multipart/form-data">
                ...
                <tr>
                    <td>
                        <c:if test="${item.use_yn eq 'Y'}">
                            <input type="hidden" class="wid100per ta_c" name="ordList[${status.index}].idx" id="ordList[${status.index}].idx" value="${item.main_img_idx}">
                    ...
                    <td class="ta_l"><a href="/ssemadmin/cont/main/img_view.do?main_img_idx=${item.main_img_idx}">${item.name}</a></td>
                    <td>${item.reg_id}</td>
        ...
        <div class="btnArea">
            ...
            <div class="right">
                <a href="/ssemadmin/cont/main/img_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
