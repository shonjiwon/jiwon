...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn_update").click(function(){
            ...
            /*if(!fnIsValidRequired(frm.thumb_atch_file_id, "썸네일파일")){return false;}*/
...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="delfrm" id="delfrm" action="/ssemadmin/cont/campus/songedu_gallery_delete.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="bbs_detail_idx" value="${bbsDetailVo.bbs_detail_idx}" />
        </form>
        <form name="frm" id="frm" action="/ssemadmin/cont/campus/songedu_gallery_view.do" method="post" enctype="multipart/form-data">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <c:forEach items="${bbsDetailVo.thumbFileList}" var="thumb" varStatus="status">
                            <div class="imgArea">
                            <span>
                ...
                <tr>
                    <th class="required">이미지대체택스트</th>
                    <td colspan="3">
                        <input type="text" class="wid750" name="alt_txt" id="alt_txt" value="${bbsDetailVo.alt_txt}">
                    </td>
                </tr>
                <tr>
                    <th>첨부파일</th>
                ...
                <tr>
                    <th>동영상URL</th>
                    <td colspan="3">
                        <input type="text" class="wid750" name="movie_url" id="movie_url" value="${bbsDetailVo.movie_url}">
                    </td>
                </tr>
                <tr>
            ...
            <div class="btnArea">
                <div class="left">
                    <a href="/ssemadmin/cont/campus/songedu_gallery_list.do" class="btn">목록</a>
                </div>
                <div class="right">
