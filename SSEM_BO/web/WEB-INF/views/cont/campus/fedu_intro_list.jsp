...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/campus/fedu_intro_list.do">
        ...
        <article class="contUnit sch_area">
            ...
            <div class="line">
                <div class="formCont">
                    <label for="searchKind">메인노출상태</label>
                ...
                <div class="formCont">
                    <label for="searchVal">센터명 검색</label>
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td class="ta_l"><a href="/ssemadmin/cont/campus/fedu_intro_view.do?future_edu_intro_idx=${item.future_edu_intro_idx}">${item.name}</a></td>
                    <td>${item.reg_id}</td>
                    <td>${fn:substring(item.reg_dt, 0, 10)}</td>
                    <td>
                        <c:choose>
                            <c:when test="${item.main_yn eq 'Y'}">노출</c:when>
                            <c:when test="${item.main_yn eq 'N'}">미노출</c:when>
        ...
        <div class="btnArea">
            <div class="right">
                <a href="/ssemadmin/cont/campus/fedu_intro_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
