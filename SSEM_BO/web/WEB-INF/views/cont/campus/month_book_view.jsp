...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if(!isEmpty(summary) && summary !== '') {
            $('#summary_length').text(summary.length);
        }
...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="delfrm" id="delfrm" action="/ssemadmin/cont/campus/month_book_delete.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="person_book_idx" value="${personBookVo.person_book_idx}" />
        </form>
        <form name="frm" id="frm" action="/ssemadmin/cont/campus/month_book_view.do" method="post" enctype="multipart/form-data">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" id="year_month" name="year_month" class="wid150" value="${personBookVo.year}-${personBookVo.month}">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" class="wid750" name="summary" id="summary" value="${personBookVo.summary}"> <span class="co_red" id="summary_length">0</span>/80
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        (파일형식: jpg, jpeg, bmp, gif, png / 사이즈 : <span class="co_red">720 * 515</span> )
