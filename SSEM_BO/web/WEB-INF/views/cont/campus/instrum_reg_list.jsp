...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/campus/instrum_reg_list.do">
        ...
        <article class="contUnit sch_area">
            ...
            <div class="line">
                <div class="formCont">
                    <label for="searchKind">악기유형</label>
                ...
                <div class="formCont">
                    <label for="searchVal">악기명 검색</label>
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td class="ta_l"><a href="/ssemadmin/cont/campus/instrum_reg_view.do?instrum_idx=${item.instrum_idx}">${item.name}</a></td>
                    <td><fmt:formatNumber value="${item.fee}" pattern="##,###"/>원/월</td>
                    <td><span class="co_red">${item.qty - item.rental_qty}</span> / ${item.qty} 개</td>
                    <td>${item.reg_id}</td>
        ...
        <div class="btnArea">
            <div class="right">
                <a href="/ssemadmin/cont/campus/instrum_reg_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
