...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="delfrm" id="delfrm" action="/ssemadmin/cont/campus/live_book_delete.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="person_book_idx" value="${personBookVo.person_book_idx}" />
        </form>
        <form name="frm" id="frm" action="/ssemadmin/cont/campus/live_book_view.do" method="post" enctype="multipart/form-data">
            ...
            <table>
                ...
                <tr>
                    <th>동영상 URL</th>
                    <td>
                        <input type="text" class="wid750" name="movie_url" id="movie_url" value="${personBookVo.movie_url}">
                    </td>
                </tr>
                <tr>
                    <th>노출순서일</th>
                    <td colspan="3">
                        <input type="text" id="ord_dt" name="ord_dt" class="wid100" value="${personBookVo.ord_dt}">
                        <a href="javascript:showCalendar('ord_dt');" style="border-bottom: 0px solid #000; !important;"><img src="/ssemadmin/resources/img/icon_cal.png"></a>
                    </td>
                </tr>
                <%--<tr>
                    <th>내용</th>
        ...
        <div class="btnArea">
            <div class="left">
                <a href="/ssemadmin/cont/campus/live_book_list.do" class="btn">목록</a>
            </div>
            <div class="right">
