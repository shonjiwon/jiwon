...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="frm" id="frm" action="/ssemadmin/cont/campus/live_book_inscr.do" method="post" enctype="multipart/form-data">
            <table>
                <colgroup>
                    <col style="width:15%">
                    <col style="width:35%">
                ...
                <tr>
                    <th>동영상 URL</th>
                    <td>
                        <input type="text" class="wid750" name="movie_url" id="movie_url">
                    </td>
                </tr>
                <tr>
                    <th>노출순서일</th>
                    <td colspan="3">
                        <input type="text" id="ord_dt" name="ord_dt" class="wid100">
