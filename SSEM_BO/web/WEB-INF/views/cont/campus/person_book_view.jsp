...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="delfrm" id="delfrm" action="/ssemadmin/cont/campus/person_book_delete.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="person_book_idx" value="${personBookVo.person_book_idx}" />
        </form>
        <form name="frm" id="frm" action="/ssemadmin/cont/campus/person_book_view.do" method="post" enctype="multipart/form-data">
        ...
        <div class="btnArea">
            <div class="left">
                <a href="/ssemadmin/cont/campus/person_book_list.do" class="btn">목록</a>
            </div>
            <div class="right">
