...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/campus/live_book_list.do">
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td class="ta_l"><a href="/ssemadmin/cont/campus/live_book_view.do?person_book_idx=${item.person_book_idx}">${item.title}</a></td>
                    <td>${item.person}</td>
                    <td>${item.reg_id}</td>
                    <td>${item.ord_dt}</td>
                    <td>
        ...
        <div class="btnArea">
            <div class="right">
                <a href="/ssemadmin/cont/campus/live_book_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
