...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/club/club_news_list.do">
    ...
    <article class="contUnit sch_area">
        ...
        <div class="line">
            ...
            <div class="formCont">
                ...
                <input type="text" id="searchVal" name="searchVal" placeholder="제목 입력" class="wid300" value="${searchVal}">
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td class="ta_l"><a href="/ssemadmin/cont/club/club_news_view.do?club_news_idx=${item.club_news_idx}">${item.title}</a></td>
                    <td>${item.reg_id}</td>
        ...
        <div class="btnArea">
            ...
            <div class="right">
                <a href="/ssemadmin/cont/club/club_news_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
