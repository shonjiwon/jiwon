...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn_insert").click(function(){
            ...
            if(frm.thumb_atch_file_id.value !== '') {
...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="frm" id="frm" action="/ssemadmin/cont/club/club_news_inscr.do" method="post" enctype="multipart/form-data">
        <table>
            <colgroup>
                <col style="width:15%">
                <col style="width:35%">
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="text" class="wid750" name="title" id="title">
                </td>
            </tr>
            <tr>
                <th>썸네일 파일</th>
                <td colspan="3">
                    ...
                    (파일형식: jpg, jpeg, bmp, gif / 사이즈 : <span class="co_red">335 * 225</span> )
                </td>
            </tr>
            <tr>
                <th>이미지대체텍스트</th>
