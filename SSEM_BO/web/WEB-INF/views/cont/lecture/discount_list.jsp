...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/lecture/discount_list.do">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td>${item.p_name}</td>
                    <td>${item.name}</td>
                    <td>${item.discount_cnt} 건</td>
                    <td><a href="/ssemadmin/cont/lecture/discount_item_list.do?group_idx=${item.group_idx}" class="btn sml blue">수정</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
