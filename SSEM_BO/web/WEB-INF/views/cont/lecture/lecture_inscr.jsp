...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btn_insert").click(function(){
            ...
            if(!fnIsValidRequired(frm.thumb_atch_file_id, "썸네일")){return false;}
...
<div class="container">
    ...
    <form name="frm" id="frm" action="/ssemadmin/cont/lecture/lecture_inscr.do" method="post" enctype="multipart/form-data">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="gubun" id="gubun_j" value="J"><label for="gubun_j">미래교육</label>
                    <input type="radio" name="gubun" id="gubun_s" value="S"><label for="gubun_s">평생교육</label>
                </td>
                <th class="required">노출여부</th>
                <td>
                    <input type="radio" name="use_yn" id="use_y" value="Y" checked><label for="use_y">노출</label>
                    <input type="radio" name="use_yn" id="use_n" value="N"><label for="use_n">비노출</label>
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="wid750" name="name" id="name"> <span class="co_red" id="txt_length">0</span>/50
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <c:forEach items="${codeList}" var="code" varStatus="status">
                        <input type="radio" name="part_code_idx" id="part_code_idx_${code.code_idx}" value="${code.code_idx}"><label for="part_code_idx_${code.code_idx}">${code.cd_val}</label>
                    </c:forEach>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="radio" name="ict_yn" id="ict_y" value="N" checked><label for="ict_y">아니오</label>
                    <input type="radio" name="ict_yn" id="ict_n" value="Y"><label for="ict_n">예</label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <c:forEach items="${tgtList}" var="tgt" varStatus="status">
                        <input type="checkbox" name="tgt_select" id="tgt_select_${tgt.code_idx}" value="${tgt.code_idx}"><label for="tgt_select_${tgt.code_idx}">${tgt.cd_val}</label>
                    </c:forEach>
                    <p class="mgt20 mgb10"><b>상세조건</b> <small>(예: 5~7세, 미취학아동, 55세이상 관내거주 등…)</small></p>
                    <input type="text" class="wid100per" name="tgt_detail" id="tgt_detail">
                </td>
            </tr>
            <tr>
                <th class="required">교육기간</th>
                <td>
                    <input type="text" id="start_dt" name="start_dt" class="wid100" value="${start_dt}">
                    ...
                    ~
                    <input type="text" id="end_dt" name="end_dt" class="wid100" value="${end_dt}">
                    ...
                    <input type="checkbox" id="dt_txt_check" class="mgl30"><label for="dt_txt_check">추가정보입력</label>
                    <input type="text" class="wid450" name="dt_txt" id="dt_txt" disabled>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select class="mgr30" name="dt_type" id="dt_type">
                        ...
                        <option value="T">격주</option>
                        <option value="Z">기타</option>
                    </select>
                    <input type="checkbox" name="dt_week_select" id="dt_week_1" value="1"><label for="dt_week_1">월</label>
                    <input type="checkbox" name="dt_week_select" id="dt_week_2" value="2"><label for="dt_week_2">화</label>
                    <input type="checkbox" name="dt_week_select" id="dt_week_3" value="3"><label for="dt_week_3">수</label>
                    <input type="checkbox" name="dt_week_select" id="dt_week_4" value="4"><label for="dt_week_4">목</label>
                    <input type="checkbox" name="dt_week_select" id="dt_week_5" value="5"><label for="dt_week_5">금</label>
                    <input type="checkbox" name="dt_week_select" id="dt_week_6" value="6"><label for="dt_week_6">토</label>
                    <input type="checkbox" name="dt_week_select" id="dt_week_7" value="7"><label for="dt_week_7">일</label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <input type="checkbox" name="time_type" id="time_type" class="mgl30" value="K"><label for="time_type">요일마다 다름</label>
                </td>
            </tr>
            <tr>
                <th class="required">접수기간</th>
                <td>
                    <input type="text" id="reg_start_st" name="reg_start_st" class="wid200">
                    ...
                    ~
                    <input type="text" id="reg_end_dt" name="reg_end_dt" class="wid200">
                    ...
                    <input type="checkbox" name="reg_type" id="reg_type" class="mgl30" value="Y"><label for="reg_type">마감시 까지</label>
                </td>
            </tr>
            <tr>
                <th class="required">신청방법</th>
                <td>
                    <input type="checkbox" name="reg_method_select" id="reg_method_1" value="1" class="mgl30"><label for="reg_method_1">온라인</label>
                    <input type="checkbox" name="reg_method_select" id="reg_method_2" value="2" class="mgl30"><label for="reg_method_2">방문</label>
                    <input type="checkbox" name="reg_method_select" id="reg_method_3" value="3" class="mgl30"><label for="reg_method_3">전화</label>
                    <input type="checkbox" name="reg_method_select" id="reg_method_4" value="4" class="mgl30"><label for="reg_method_4">외부홈페이지</label>

                    <input type="text" class="wid450" name="reg_method_url" id="reg_method_url" disabled>
                </td>
            </tr>
            <tr>
                <th class="required">교육인원</th>
                <td>
                    정원 <input type="text" class="wid70 mgl10" name="student_qty" id="student_qty" oninput="this.value = this.value.replace(/[^0-9]/g, '');"> 명
                </td>
            </tr>
            <tr>
                <th class="required">모집인원</th>
                <td>
                    인터넷 <input type="text" class="wid70 mgl10" name="online_qty" id="online_qty" oninput="this.value = this.value.replace(/[^0-9]/g, '');"> 명
                    (대기 <input type="text" class="wid70 mgl10" name="wait_qty" id="wait_qty" oninput="this.value = this.value.replace(/[^0-9]/g, '');"> 명)
                    | 방문 <input type="text" class="wid70 mgl10" name="visit_qty" id="visit_qty" oninput="this.value = this.value.replace(/[^0-9]/g, '');"> 명
                    | 전화 <input type="text" class="wid70 mgl10" name="tel_qty" id="tel_qty" oninput="this.value = this.value.replace(/[^0-9]/g, '');"> 명
                    <div class="mgt10">
                        <input type="checkbox" name="qty_open_yn" id="qty_open_yn" value="N">
            ...
            <tr>
                <th>연령제한</th>
                <td>
                    <input type="radio" name="age_type" id="age_type_u" value="U" checked><label for="age_type_u">제한없음</label>
                    <input type="radio" name="age_type" id="age_type_l" value="L"><label for="age_type_l">14세이상</label>
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="fee_type" id="fee_type_f" value="F"><label for="fee_type_f">무료</label>
                    <input type="radio" name="fee_type" id="fee_type_s" value="S"><label for="fee_type_s">유료</label>
                    <%--<input type="text" class="wid100 mgl10" name="fee" id="fee" onkeyup="numberWithCommas(this.value, 'fee');" oninput="this.value = this.value.replace(/[^0-9]/g, '');" disabled> 원--%>
                    <input type="text" class="wid100 mgl10" name="fee" id="fee" oninput="this.value = this.value.replace(/[^0-9]/g, '');" disabled> 원
                    <div class="mgt10">
                        상세조건 <input type="text" class="wid700 mgl10" name="fee_detail" id="fee_detail">
                    </div>
                </td>
            </tr>
            <tr id="pay_type_hide">
                ...
                <td>
                    <input type="radio" name="pay_type" id="pay_type_i" value="I"><label for="pay_type_i">온라인결제</label>
                    <input type="radio" name="pay_type" id="pay_type_c" value="C"><label for="pay_type_c">현장결제</label>
            ...
            <tr id="discount_yn_hide">
                ...
                <td>
                    <input type="radio" name="discount_yn" id="discount_yn_n" value="N"><label for="discount_yn_n">해당없음</label>
                    ...
                    <input type="hidden" name="discount_str" id="discount_str" />
                </td>
            </tr>
            <tr id="refund_txt_hide">
                <th>환불정책</th>
                <td>
                    <textarea rows="5" class="wid100per" name="refund_txt" id="refund_txt"></textarea>
                </td>
            </tr>
            <tr id="refund_dt_hide">
                <th>환불기간</th>
                <td>
                    <input type="text" id="refund_start_dt" name="refund_start_dt" class="wid100" value="${refund_start_dt}">
                    ...
                    ~
                    <input type="text" id="refund_end_dt" name="refund_end_dt" class="wid100" value="${refund_end_dt}">
            ...
            <tr>
                <th>특이사항</th>
                <td>
                    <textarea rows="5" class="wid100per" name="desc_txt" id="desc_txt"></textarea>
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <table>
            ...
            <tr>
                <th>강사</th>
                <td>
                    <input type="radio" name="teacher_yn" id="teacher_y" value="Y"><label for="teacher_y">확정</label>
                    <input type="text" class="wid100" id="teacher_nm" name="teacher_nm" disabled>
                    <input type="hidden" id="teacher_idx" name="teacher_idx">
                    <a href="#none" class="btn sml blue" onclick="pop_teacher()">선택</a>
                    <input type="radio" name="teacher_yn" id="teacher_n" value="N" class="mgl20" checked><label for="teacher_n">미정</label>
                </td>
            </tr>
            <tr>
                <th>첨부파일</th>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="wid350" id="room_name">
                    <input type="hidden" id="study_place_idx" name="study_place_idx">
            ...
            <tr>
                ...
                <td>
                    <textarea rows="5" id="cont" name="cont" class="wid100per"></textarea>
                </td>
            </tr>
            </tbody>
        </table>
