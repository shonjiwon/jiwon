...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var mob_no = '${lectureApyVo.apy_mob_no}';
        if(mob_no !== '') {
        ...
        var ref_mob_no = '${lectureApyVo.apy_ref_mob_no}';
        if(ref_mob_no !== '') {
            var jbSplit = ref_mob_no.split('-');
            $("#ref_mob_1").val(jbSplit[0]);
            $("#ref_mob_2").val(jbSplit[1]);
            $("#ref_mob_3").val(jbSplit[2]);
        }
...
<div class="container">
    ...
    <form name="frm_update" id="frm_update" method="post" action="/ssemadmin/cont/lecture/apply_student_offline_update.do" enctype="multipart/form-data">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" class="wid250" id="apy_name" name="apy_name" value="${lectureApyVo.apy_name}"></td>
                <th class="required">생년월일</th>
                <td>
                    <input type="text" id="apy_birth" name="apy_birth" class="wid100" value="${lectureApyVo.apy_birth}">
            ...
            <tr>
                ...
                <td>
                    <input type="radio" name="apy_gender" id="apy_gender_m" value="M" <c:if test="${lectureApyVo.apy_gender eq 'M'}">checked</c:if>><label for="apy_gender_m">남</label>
                    <input type="radio" name="apy_gender" id="apy_gender_f" value="F" <c:if test="${lectureApyVo.apy_gender eq 'F'}">checked</c:if>><label for="apy_gender_f">여</label>
                </td>
            ...
            <tr>
                <th>대리여부</th>
                <td colspan="3">
                    <input type="radio" name="ref_check" id="ref_check_y" value="Y" <c:if test="${lectureApyVo.apy_ref ne null}">checked</c:if>><label for="ref_check_y">Y</label>
                    <input type="radio" name="ref_check" id="ref_check_n" value="N" <c:if test="${lectureApyVo.apy_ref eq null}">checked</c:if>><label for="ref_check_n">N</label>
                </td>
            </tr>
            <tr id="hide_1" <c:if test="${lectureApyVo.apy_ref eq null}">style="display: none;"</c:if>>
                <th class="required">신청자와의 관계</th>
                <td colspan="3">
                    <input type="text" class="wid250" id="apy_ref" name="apy_ref" value="${lectureApyVo.apy_ref}">
                </td>
            </tr>
            <tr id="hide_2" <c:if test="${lectureApyVo.apy_ref eq null}">style="display: none;"</c:if>>
                <th class="required">교육대상자 이름</th>
                <td>
                    <input type="text" class="wid250" id="apy_real_name" name="apy_real_name" value="${lectureApyVo.apy_real_name}">
                </td>
            ...
            <%--<tr>
                ...
                <td colspan="3">
                    <input type="radio" name="apy_method" id="apy_method_2" value="2" <c:if test="${lectureApyVo.apy_method eq '2'}">checked</c:if>><label for="apy_method_2">방문</label>
                    <input type="radio" name="apy_method" id="apy_method_3" value="3" <c:if test="${lectureApyVo.apy_method eq '3'}">checked</c:if>><label for="apy_method_3">전화</label>
                </td>
                <th>신청일</th>
                <td>
            ...
            <%--<tr>
                <th>성명/대리신청자</th>
                <td>
                    <input type="text" class="wid350 mgt10" value="${lectureApyVo.apy_name}" id="apy_name" name="apy_name" value="${lectureApyVo.apy_name}">
    ...
    <article class="contUnit tbl_area">
        ...
        <form name="frm" id="frm" method="post" action="/ssemadmin/cont/lecture/apply_student_offline_view.do?lecture_apy_idx=${lectureApyVo.lecture_apy_idx}">
