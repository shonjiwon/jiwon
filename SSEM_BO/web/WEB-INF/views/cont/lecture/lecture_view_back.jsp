...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btn_update").click(function(){
            ...
            var tgt_code = frm.tgt_code.value.trim();
            if(tgt_code === '') {
                modalMsg("[대상]을(를) 선택해 주세요.", 'notice', goFocus('tgt_code'));
                return false;
            } else {
                frm.tgt_code.value = tgt_code.replaceAll(' ', ',');
            }
            ...
            var dt_week = frm.dt_week.value.trim();
            if(dt_week === '') {
                modalMsg("[교육요일]을(를) 선택해 주세요.", 'notice', goFocus('dt_week'));
                return false;
            } else {
                frm.dt_week.value = dt_week.replaceAll(' ', ',');
            }
            ...
            var reg_method = frm.reg_method.value.trim();
            if(reg_method === '') {
                modalMsg("[신청방법]을(를) 선택해 주세요.", 'notice', goFocus('reg_method'));
                return false;
            } else {
                frm.reg_method.value = reg_method.replaceAll(' ', ',');
            }
...
<div class="container">
    ...
    <form name="frm" id="frm" action="/ssemadmin/cont/lecture/lecture_view_back.do" method="post" enctype="multipart/form-data">
        <input type="hidden" name="lecture_idx" value="${lectureVo.lecture_idx}" />
        <input type="hidden" name="start_time" id="start_time" />
        <input type="hidden" name="end_time" id="end_time" />
        <input type="hidden" name="discount_yn" id="discount_yn" value="${lectureVo.discount_yn}"/>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" class="wid250" name="tgt_code" id="tgt_code" value="${lectureVo.tgt_code}">
                        <p class="mgt20 mgb10"><b>상세조건</b> <small>(예: 5~7세, 미취학아동, 55세이상 관내거주 등…)</small></p>
                        <input type="text" class="wid450" name="tgt_detail" id="tgt_detail" value="${lectureVo.tgt_detail}">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" class="wid450" name="dt_week" id="dt_week" value="${lectureVo.dt_week}">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" class="wid450" name="reg_method" id="reg_method" value="${lectureVo.reg_method}">
                ...
                <tr id="discount_yn_hide">
                    ...
                    <td>
                        <input type="text" class="wid700" name="discount_str" id="discount_str" value="${lectureVo.discount_str}"/>
                        <ul class="list dash">
