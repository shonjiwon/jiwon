            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data !== 0) {
                        ...
                        document.location.href="/ssemadmin/cont/excel/old_teacher_pay_list.do?" + param;
                    } else {
                        alert("등록에 실패하였습니다.");
                    }
                }
...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/self/old_teacher_pay_list.do">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td><a href="/ssemadmin/cont/self/old_teacher_pay_view.do?lecturer_cost=${item.lecturer_cost}">${item.dong_cd}</a></td>
                    <td><fmt:formatNumber value="${item.classroom_cnt}" pattern="##,###"/></td>
                    <td>
                        <fmt:formatNumber value="${item.course_cnt}" pattern="##,###"/>
                    </td>
                    <td><fmt:formatNumber value="${item.lecturer_cnt}" pattern="##,###"/></td>
