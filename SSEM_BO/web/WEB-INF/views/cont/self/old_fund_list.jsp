            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data !== 0) {
                        ...
                        document.location.href="/ssemadmin/cont/excel/old_fund_list.do?" + param;
                    } else {
                        alert("등록에 실패하였습니다.");
                    }
                }
...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/self/old_fund_list.do">
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <tr style="background:#fdf9db;">
                ...
                <td>-</td>
                <td>-</td>
                <td class="ta_r"><fmt:formatNumber value="${totAmount}" pattern="##,###"/></td>
                <td>-</td>
            </tr>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${item.div_cd eq '10600001'}">일반</c:when>
                            <c:when test="${item.div_cd eq '10600002'}">헬스장</c:when>
                        </c:choose>
                    </td>
