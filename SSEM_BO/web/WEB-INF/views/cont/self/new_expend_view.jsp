...
<div class="container">
    ...
    <form name="delfrm" id="delfrm" action="/ssemadmin/cont/self/new_expend_delete.do" method="post" enctype="multipart/form-data">
        <input type="hidden" name="inout_seq" value="${newTracInoutVo.inout_seq}"/>
        <input type="hidden" name="ref_seq" value="${newTracInoutVo.ref_seq}"/>
    </form>
    <article class="contUnit tbl_area leftType">
        ...
        <form name="frm" id="frm" action="/ssemadmin/cont/self/new_expend_view.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="inout_seq" value="${newTracInoutVo.inout_seq}"/>
            <table>
                <colgroup>
                    <col style="width:15%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" class="wid150" id="old_ref_seq" name="old_ref_seq" value="${newTracInoutVo.ref_seq}">
                    </td>
                    <th>환불프로그램</th>
                    <td>
