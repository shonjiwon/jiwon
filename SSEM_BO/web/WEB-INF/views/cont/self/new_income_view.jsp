...
<div class="container">
    ...
    <form name="delfrm" id="delfrm" action="/ssemadmin/cont/self/new_income_delete.do" method="post" enctype="multipart/form-data">
        <input type="hidden" name="inout_seq" value="${newTracInoutVo.inout_seq}" />
    </form>
    <article class="contUnit tbl_area leftType">
        ...
        <form name="frm" id="frm" action="/ssemadmin/cont/self/new_income_view.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="inout_seq" value="${newTracInoutVo.inout_seq}" />
            <table>
                <colgroup>
                    <col style="width:15%">
                ...
                <tr>
                    ...
                    <th>생년월일</th>
                    <td>
                        <input type="text" id="birth" name="birth" class="wid150" value="${newTracInoutVo.birth}">
                    </td>
                </tr>
                <tr>
                    <th>성별</th>
                ...
                <tr>
                    <th>감면율</th>
                    <td>
                        <input type="text" class="wid50" id="discount_rate" name="discount_rate" value="${newTracInoutVo.discount_rate}"> % <a href="#none" class="btn sml grey" onclick="pop_discount()">감면정보수정</a>
                        <input type="hidden" class="wid200" id="discount_idx" name="discount_idx" value="${newTracInoutVo.discount_idx}">
                    </td>
                    <th>감면사항</th>
                    <td>
                        <input type="text" class="wid250" id="discount_info" name="discount_info" value="${newTracInoutVo.discount_info}">
                    </td>
                </tr>
                <tr>
                    <th>비고</th>
        ...
        <div class="btnArea">
            ...
            <div class="right">
                ...
                <a href="#none" class="btn red" id="btn_delete">삭재</a>
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                <tr>
                    ...
                    <td>${item.refund_dt}</td>
                    <td><fmt:formatNumber value="${item.refund_cost}" pattern="##,###"/></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
