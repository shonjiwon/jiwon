...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        <div class="btnArea mgt0 mgb10 of_h">
            <div class="left">
                <span class="co_red">*지출구분이 ‘환불’인 경우, [수입목록] 을 클릭하여 해당 정보를 조회(선택)하세요.</span>
            </div>
            <div class="right">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="wid150" id="inout_cost" name="inout_cost" oninput="this.value = this.value.replace(/[^0-9]/g, '');"> 원
                </td>
            </tr>
            <tr>
                <th class="required">내역</th>
                <td colspan="3">
                    <input type="text" class="wid100per" id="e_note" name="e_note">
                </td>
            </tr>
            <tr>
                <th class="required">이름</th>
                <td>
                    <input type="text" class="wid150" id="inout_nm" name="inout_nm"> <a href="#none" class="btn sml grey mgl10" onclick="pop_income_list()">수입목록</a>
                    <input type="hidden" class="wid150" id="ref_seq" name="ref_seq">
                    <input type="hidden" class="wid150" id="student_idx" name="student_idx">
                </td>
                <th>환불프로그램</th>
                <td>
                    <input type="text" class="wid250" id="lecture_nm" name="lecture_nm">
                    <input type="hidden" class="wid150" id="lecture_idx" name="lecture_idx">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <select class="wid150" id="method_cd" name="method_cd">
                        <option value="">선택하세요</option>
                        <option value="1">계좌입금</option>
                        <option value="2">현금입금</option>
                        <option value="3">지로입금</option>
                        <option value="4">카드지급</option>
                    </select>
                </td>
                <th>은행명</th>
                <td>
                    <select class="wid150" id="bank_cd" name="bank_cd">
                        ...
                        <c:forEach items="${bankList}" var="bank" varStatus="status">
                            <option value="${bank.code_idx}">${bank.cd_val}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
            <tr>
                <th>계좌번호</th>
                <td colspan="3">
                    <input type="text" class="wid100per" id="bank_no" name="bank_no">
                </td>
            </tr>
            <tr>
                <th>비고</th>
