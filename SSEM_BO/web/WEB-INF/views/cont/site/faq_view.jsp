...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="delfrm" id="delfrm" action="/ssemadmin/cont/site/faq_delete.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="bbs_detail_idx" value="${bbsDetailVo.bbs_detail_idx}" />
        </form>
        <form name="frm" id="frm" action="/ssemadmin/cont/site/faq_view.do" method="post" enctype="multipart/form-data">
        ...
        <div class="btnArea">
            <div class="left">
                <a href="/ssemadmin/cont/site/faq_list.do" class="btn">목록</a>
            </div>
            <div class="right">
