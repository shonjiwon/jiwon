...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/magnet/channel_study_list.do">
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td><a href="/ssemadmin/cont/magnet/channel_study_view.do?channel_study_idx=${item.channel_study_idx}">${item.title}</a></td>
                    <td>${item.reg_id}</td>
        ...
        <div class="btnArea">
            <div class="right">
                <a href="/ssemadmin/cont/magnet/channel_study_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
