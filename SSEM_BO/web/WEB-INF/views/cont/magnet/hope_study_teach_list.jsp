...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data !== 0) {
                        ...
                        document.location.href="/ssemadmin/cont/excel/hope_study_teach_list_excel.do?" + param;
                    } else {
                        alert("등록에 실패하였습니다.");
                    }
                }
    ...
    function pop_can_teach(idx) {
        var url = "/ssemadmin/popup/magnet/can_teach_info.do?teach_study_idx=" + idx;
        window.open(url, 'popup_can_teach', 'width=800, height=500, scrollbars=0, toolbar=0, menubar=no');
    }
...
<div class="container">
    ...
    <article class="contUnit tbl_area">
        ...
        <form name="frm_list" id="frm_list" action="/ssemadmin/cont/magnet/hope_study_teach_list.do?hope_study_idx=${hopeStudyVo.hope_study_idx}" method="post" enctype="multipart/form-data">
                ...
                <div class="line">
                    <div class="formCont">
                        ...
                        <select id="list_type" class="wid150">
                            <option value="A">함께해요</option>
                            <option value="B" selected="selected">가르칠 수 있어요</option>
                        </select>
                    </div>
                </div>
                <div class="line">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td>
                        <a href="#none" class="popOpen" onclick="pop_can_teach('${item.teach_study_idx}')">${item.apy_name}</a>
                    </td>
                    <td>${item.apy_id}</td>
                    ...
                    <td>
                        <c:if test="${item.teach_atch_file_id ne null}">
                            <img src="/ssemadmin/resources/img/icon_file.png" class="wid20">
                        </c:if>
                    </td>
                    <td>
                        <c:if test="${item.career_atch_file_id ne null}">
                            <img src="/ssemadmin/resources/img/icon_file.png" class="wid20">
                        </c:if>
                    </td>
        ...
        <div class="cont">
            <article class="contUnit tbl_area leftType">
                ...
                <form name="excel_frm" id="excel_frm" method="post" action="/ssemadmin/cont/excel/private_insert.do">
                    ...
                    <input type="hidden" name="level3" id="level3" value="가르칠 수 있어요"/>
                    <table>
                        <colgroup>
