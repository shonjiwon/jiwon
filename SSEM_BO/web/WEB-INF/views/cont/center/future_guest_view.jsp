...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="delfrm" id="delfrm" action="/ssemadmin/cont/center/future_guest_delete.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="bbs_detail_idx" value="${bbsDetailVo.bbs_detail_idx}" />
        </form>
        <form name="frm" id="frm" action="/ssemadmin/cont/center/future_guest_view.do" method="post" enctype="multipart/form-data">
            ...
            <table>
                ...
                <tr>
                    ...
                    <th>작성일</th>
                    <td>${bbsDetailVo.up_dt}</td>
                </tr>
                <tr>
                    <th class="required">제목</th>
                    <td colspan="3">
                        <input type="text" class="wid750" name="title" id="title" value="${bbsDetailVo.title}"> <span class="co_red">0</span>/50
                    </td>
                </tr>
                <tr>
        ...
        <div class="btnArea">
            <div class="left">
                <a href="/ssemadmin/cont/center/future_guest_list.do" class="btn">목록</a>
            </div>
            <div class="right">
