...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/center/machun_banner_list.do">
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <tbody>
            <form name="ordfrm" id="ordfrm" method="post" action="/ssemadmin/cont/center/machun_banner_ord.do" enctype="multipart/form-data">
                ...
                <c:forEach items="${itemList}" var="item" varStatus="status">
                    <tr>
                        ...
                        <td class="ta_l"><a href="/ssemadmin/cont/center/machun_banner_view.do?banner_idx=${item.banner_idx}">${item.name}</a></td>
                        <td>${item.reg_id}</td>
        ...
        <div class="btnArea">
            ...
            <div class="right">
                <a href="/ssemadmin/cont/center/machun_banner_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
