...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/center/dream_gallery_list.do">
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td class="ta_l"><a href="/ssemadmin/cont/center/dream_gallery_view.do?bbs_detail_idx=${item.bbs_detail_idx}">${item.title}</a></td>
                    <td>${item.reg_id}</td>
        ...
        <div class="btnArea">
            <div class="right">
                <a href="/ssemadmin/cont/center/dream_gallery_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
