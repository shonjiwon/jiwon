...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="delfrm" id="delfrm" action="/ssemadmin/cont/center/jamsil_banner_delete.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="banner_idx" value="${bannerVo.banner_idx}" />
        </form>
        <form name="frm" id="frm" action="/ssemadmin/cont/center/jamsil_banner_view.do" method="post" enctype="multipart/form-data">
