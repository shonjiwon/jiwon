...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/center/machun_notice_list.do">
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td>${item.p_name}</td>
                    <td>${item.grp_name}</td>
                    <td class="ta_l"><a href="/ssemadmin/cont/center/machun_notice_view.do?bbs_detail_idx=${item.bbs_detail_idx}">${item.title}</a></td>
                    <td>${item.reg_id}</td>
        ...
        <div class="btnArea">
            <div class="right">
                <a href="/ssemadmin/cont/center/machun_notice_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
