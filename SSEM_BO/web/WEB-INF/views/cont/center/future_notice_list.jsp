...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/ssemadmin/cont/center/future_notice_list.do">
        ...
        <article class="contUnit sch_area">
            ...
            <div class="line">
                <div class="formCont">
                    ...
                    <input type="text" id="sel01" class="wid200" value="${adminLoginVo.p_name}" disabled>
                </div>
                <div class="formCont">
                    <label for="sel02">교육기관</label>
                    <input type="text" id="sel02" class="wid200" value="${adminLoginVo.grp_name}" disabled>
                </div>
            </div>
            <div class="line">
                <div class="formCont">
    ...
    <article class="contUnit tbl_area">
        ...
        <table>
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                ...
                <tr>
                    ...
                    <td>${item.p_name}</td>
                    <td>${item.grp_name}</td>
                    <td class="ta_l"><a href="/ssemadmin/cont/center/future_notice_view.do?bbs_detail_idx=${item.bbs_detail_idx}">${item.title}</a></td>
                    <td>${item.reg_id}</td>
                    ...
                    <td>
                        <c:choose>
                            <c:when test="${item.top_yn eq 'Y'}">상단고정</c:when>
                            <c:when test="${item.top_yn eq 'N'}">일반</c:when>
                            <c:otherwise>-</c:otherwise>
                        </c:choose>
                    </td>
        ...
        <div class="btnArea">
            <div class="right">
                <a href="/ssemadmin/cont/center/future_notice_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
