...
<section class="wrap pop">
    <div class="container">
        <article class="contUnit tbl_area leftType">
            ...
            <form name="frm_add" id="frm_add" method="post" action="/ssemadmin/popup/lecture/reg_room_insert.do" enctype="multipart/form-data">
                <input type="hidden" name="group_idx" value="${studyPlaceVo.group_idx}"/>
                <input type="hidden" name="study_place_idx" value="${studyPlaceVo.study_place_idx}"/>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="ta_l">
                        <input type="text" id="start_dt" name="start_dt" class="wid150">
                        ...
                        ~
                        <input type="text" id="end_dt" name="end_dt" class="wid150">
                ...
                <tr>
                    ...
                    <td class="ta_l">
                        <input type="text" class="wid350" name="name" id="name" placeholder="예약명"> <span class="co_red" id="txt_length">0</span>/50
                    </td>
                </tr>
                <tr>
            ...
            <div class="btnArea">
                ...
                <div class="right">
                    <a href="#none" class="btn red" id="btn_add_isnert">저장</a>
