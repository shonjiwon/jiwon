...
public class HopeStudyVo implements Serializable {

  private static final long serialVersionUID = 8737229282145262229L;
  ...
  public long getGrp_cnt() {
    return grp_cnt;
  }

  public void setGrp_cnt(long grp_cnt) {
  ...
  public int getTeach_cnt() {
    return teach_cnt;
  }

  public void setTeach_cnt(int teach_cnt) {
    this.teach_cnt = teach_cnt;
  }
