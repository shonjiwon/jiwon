...
public class Constants {
    ...
    public static final String CODE_TYPE_EG = "ORGM";		// 응급기관 OG01020000
    public static final String CODE_TYPE_HG = "ORGM";		// 종별
    public static final String CODE_TYPE_SUB = "ORGM";		// 진료과목
    public static final String CODE_TYPE_OTHER = "ORGM";		// 진료과목
    public static final String CODE_TYPE_OG = "ORGS";		// 보건소 기관구분
    public static final String CODE_TYPE_KD = "ORGM";		// 시설종류
    ...
    public static final String youth_login_url = "/ssem/youth/login/login.do";
    public static final String youth_pwd_confirm_url = "/ssem/youth/mypage/pwd_confirm.do";
    public static final String senior_login_url = "/ssem/senior/login/login.do";
}
