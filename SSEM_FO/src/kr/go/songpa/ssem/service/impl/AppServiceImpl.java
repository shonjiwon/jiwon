...
public class AppServiceImpl implements AppService {
    ...
    @Override
    public int selectGroupIdx(String name) throws Exception {
        return appRepoistory.selectGroupIdx(name);
    }

    @Override
    public List<String> selectGroupIdxList(String p_name) throws Exception {
        return appRepoistory.selectGroupIdxList(p_name);
    }

    @Override
    public List<GroupVo> selectSubGroupListAll() throws Exception {
        return appRepoistory.selectSubGroupListAll();
    }
}
