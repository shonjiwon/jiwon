 ...
 */
@Controller
public class CenterSongpaController extends CommonController {
    ...
    public CenterSongpaController() {
    }

    @RequestMapping(value = "/songpacenter/main/main.do", method = RequestMethod.GET)
    public String main(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/main/main";
        int group_idx = appService.selectGroupIdx("송파청소년센터");
        // 송파청소년센터 메인 배너
        BannerVo bannerVo = new BannerVo();
        bannerVo.setGubun("SONGPA");
    ...
    @RequestMapping(value = "/songpacenter/intro/intro.do", method = RequestMethod.GET)
    public String intro_intro(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/intro/intro";

        return ret_url;
    }

    @RequestMapping(value = "/songpacenter/intro/use.do", method = RequestMethod.GET)
    public String intro_use(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/intro/use";

        return ret_url;
    }

    @RequestMapping(value = "/songpacenter/biz/youth.do", method = RequestMethod.GET)
    public String biz_youth(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/biz/youth";

        return ret_url;
    }

    @RequestMapping(value = "/songpacenter/biz/child.do", method = RequestMethod.GET)
    public String biz_child(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/biz/child";

        return ret_url;
    }

    @RequestMapping(value = "/songpacenter/biz/alternative.do", method = RequestMethod.GET)
    public String biz_alternative(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/biz/alternative";

        return ret_url;
    }

    @RequestMapping(value = "/songpacenter/biz/life.do", method = RequestMethod.GET)
    public String biz_life(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/biz/life";

        return ret_url;
    }

    @RequestMapping(value = "/songpacenter/place/intro.do", method = RequestMethod.GET)
    public String place_intro(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/place/intro";

        return ret_url;
    }

    @RequestMapping("/songpacenter/news/notice_list.do")
    public String notice_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/news/notice_list";
    ...
    @RequestMapping(value = "/songpacenter/news/notice_view.do", method = RequestMethod.GET)
    public String notice_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/news/notice_view";
    ...
    @RequestMapping(value = "/songpacenter/news/qna_list.do", method = RequestMethod.GET)
    public String news_qna_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/news/qna_list";
    ...
    @RequestMapping("/songpacenter/program/program_list.do")
    public String program_program_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/program/program_list";
    ...
    @RequestMapping(value = "/songpacenter/program/program_view.do", method = RequestMethod.GET)
    public String program_program_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/program/program_view";
    ...
    @RequestMapping(value = "/songpacenter/program/love_insert.do", method = RequestMethod.POST)
    public String program_love_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/songpacenter/program/program_view.do?lecture_idx=" + loveVo.getLecture_idx());
                ...
                if(count == 0) {
                    ...
                    model.addAttribute("locurl", "/ssem/songpacenter/program/program_view.do?lecture_idx=" + loveVo.getLecture_idx());
                } else {
    ...
    @RequestMapping(value = "/songpacenter/main/privacy.do", method = RequestMethod.GET)
    public String main_privacy(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/main/privacy";

        return ret_url;
    }

    @RequestMapping(value = "/songpacenter/main/terms.do", method = RequestMethod.GET)
    public String main_terms(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/main/terms";

        return ret_url;
    }

    @RequestMapping(value = "/songpacenter/main/mail.do", method = RequestMethod.GET)
    public String main_mail(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/main/mail";

        return ret_url;
    }

    @RequestMapping(value = "/songpacenter/main/copyright.do", method = RequestMethod.GET)
    public String main_copyright(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "songpacenter/main/copyright";
