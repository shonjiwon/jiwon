 ...
 */
@Controller
public class CenterJamsilController extends CommonController {
    ...
    public CenterJamsilController() {
    }

    @RequestMapping(value = "/jamsilcenter/main/main.do", method = RequestMethod.GET)
    public String jamsil_main(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/main/main";

        int group_idx = appService.selectGroupIdx("잠실청소년센터");
        // 송파청소년센터 메인 배너
        BannerVo bannerVo = new BannerVo();
        bannerVo.setGubun("JAMSIL");
    ...
    @RequestMapping(value = "/jamsilcenter/intro/intro.do", method = RequestMethod.GET)
    public String jamsil_intro(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/intro/intro";

        return ret_url;
    }

    @RequestMapping("/jamsilcenter/program/program_list.do")
    public String jamsil_program_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/program/program_list";
    ...
    @RequestMapping(value = "/jamsilcenter/program/program_view.do", method = RequestMethod.GET)
    public String jamsil_program_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/program/program_view";
    ...
    @RequestMapping(value = "/jamsilcenter/program/love_insert.do", method = RequestMethod.POST)
    public String jamsil_program_love_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/jamsilcenter/program/program_view.do?lecture_idx=" + loveVo.getLecture_idx());
                ...
                if(count == 0) {
                    ...
                    model.addAttribute("locurl", "/ssem/jamsilcenter/program/program_view.do?lecture_idx=" + loveVo.getLecture_idx());
                } else {
    ...
    @RequestMapping(value = "/jamsilcenter/biz/culture.do", method = RequestMethod.GET)
    public String jamsil_biz_culture(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/biz/culture";

        return ret_url;
    }

    @RequestMapping(value = "/jamsilcenter/biz/youth.do", method = RequestMethod.GET)
    public String jamsil_biz_youth(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/biz/youth";

        return ret_url;
    }

    @RequestMapping(value = "/jamsilcenter/biz/counsel.do", method = RequestMethod.GET)
    public String jamsil_biz_counsel(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/biz/counsel";

        return ret_url;
    }

    @RequestMapping(value = "/jamsilcenter/fac/intro.do", method = RequestMethod.GET)
    public String jamsil_fac_intro(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/fac/intro";

        return ret_url;
    }

    @RequestMapping("/jamsilcenter/news/notice_list.do")
    public String machun_news_notice_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/news/notice_list";
    ...
    @RequestMapping(value = "/jamsilcenter/news/notice_view.do", method = RequestMethod.GET)
    public String machun_news_notice_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/news/notice_view";
    ...
    @RequestMapping(value = "/jamsilcenter/news/qna_list.do", method = RequestMethod.GET)
    public String machun_news_qna_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/news/qna_list";
    ...
    @RequestMapping(value = "/jamsilcenter/main/privacy.do", method = RequestMethod.GET)
    public String main_privacy(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/main/privacy";

        return ret_url;
    }

    @RequestMapping(value = "/jamsilcenter/main/terms.do", method = RequestMethod.GET)
    public String main_terms(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/main/terms";

        return ret_url;
    }

    @RequestMapping(value = "/jamsilcenter/main/mail.do", method = RequestMethod.GET)
    public String main_mail(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/main/mail";

        return ret_url;
    }

    @RequestMapping(value = "/jamsilcenter/main/copyright.do", method = RequestMethod.GET)
    public String main_copyright(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "jamsilcenter/main/copyright";
