 ...
 */
@Controller
public class SeniorMyPageController extends CommonController {
    @Autowired
    ...
    public SeniorMyPageController() {
    }

    @RequestMapping(value = "/senior/mypage/pwd_confirm.do", method = RequestMethod.GET)
    public String senior_pwd_confirm(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/pwd_confirm";
        ...
        if(loginVo == null) {
            ...
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/pwd_confirm.do");
    ...
    @RequestMapping(value = "/senior/mypage/pwd_confirm.do", method = RequestMethod.POST)
    public String senior_pwd_confirm_proc(@ModelAttribute TnUserInfoVo tnUserInfoVo, HttpServletRequest request, Model model) throws Exception {
        String ret_url = "";
        ...
        if(loginVo == null) {
            ...
            if (code == 9) {
                ...
                if("".equals(tnUserInfoVo.getReturn_url())) {
                    url = "/senior/mypage/program_list.do";
                } else {
                ...
                // 오류
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", "/ssem/senior/mypage/pwd_confirm.do");
    ...
    @RequestMapping("/senior/mypage/program_list.do")
    public String senior_program_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/program_list";
        ...
        if(loginVo == null) {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/program_list.do");
    ...
    @RequestMapping(value = "/senior/mypage/program_view.do", method = RequestMethod.GET)
    public String senior_program_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/program_view";
        ...
        if (loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/program_view.do?lecture_apy_idx=" + lecture_apy_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url = "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/program_view.do?lecture_apy_idx=" + lecture_apy_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
            // 신청 정보
    ...
    @RequestMapping(value = "/senior/mypage/program_payment.do", method = RequestMethod.POST)
    public String senior_program_pay_ok(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/program_view.do?lecture_apy_idx=" + payVo.getLecture_apy_idx());
                model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
                ret_url =  "common/message";
            } else {
                ...
                if ( xpay.TX() ) {
                    ...
                    if( "0000".equals( xpay.m_szResCode ) ) {
                        ...
                        if( check_sucs == 0 ) {
                            ...
                            model.addAttribute("locurl", "/ssem/senior/mypage/program_view.do?lecture_apy_idx=" + payVo.getLecture_apy_idx());
                            ret_url = "common/message";
                        }
                        ...
                        model.addAttribute("msg", "alterBack");
                        model.addAttribute("altmsg", "통신상의 문제가 있습니다. m_szResCode : " + xpay.m_szResCode);
                        return ret_url;
                    ...
                    lectureService.updateLectureApyPayResult(lectureApyVo);
                    model.addAttribute("msg", "alterBack");
                    model.addAttribute("altmsg", "저장에 실패하였습니다. 결제모듈 초기화 실패");
                    return ret_url;
                }
            }
        } catch (Exception e) {
    ...
    @RequestMapping(value = "/senior/mypage/program_payment_cancel.do", method = RequestMethod.POST)
    public String senior_program_pay_cancel(final MultipartHttpServletRequest multiRequest,
                                           @ModelAttribute("payVo") PayVo payVo,
                                           BindingResult bindingResult,
                                           Model model,
                                           SessionStatus status)  throws Exception {
    ...
    @RequestMapping(value = "/senior/mypage/program_apy_cancel.do", method = RequestMethod.POST)
    public String senior_program_apy_cancel(final MultipartHttpServletRequest multiRequest,
                                           @ModelAttribute("payVo") PayVo payVo,
                                           BindingResult bindingResult,
                                           Model model,
                                           SessionStatus status)  throws Exception {
    ...
    @RequestMapping(value = "/senior/mypage/program_apy_refund.do", method = RequestMethod.POST)
    public String senior_program_apy_refund(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/program_view.do?lecture_apy_idx=" + lectureApyVo.getLecture_apy_idx());
                model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
                ret_url =  "common/message";
            } else {
                ...
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", "/ssem/senior/mypage/program_view.do?lecture_apy_idx=" + lectureApyVo.getLecture_apy_idx());
    ...
    @RequestMapping("/senior/mypage/attend_list.do")
    public String senior_attend_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/attend_list";
        ...
        if(loginVo == null) {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/attend_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
            // 파라미터 세팅
    ...
    @RequestMapping(value = "/senior/mypage/attend_view.do", method = RequestMethod.GET)
    public String senior_attend_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/attend_view";
        ...
        if (loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/attend_view.do?lecture_apy_idx=" + lecture_apy_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url = "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/attend_view.do?lecture_apy_idx="  + lecture_apy_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping("/senior/mypage/teacher_love_list.do")
    public String senior_teacher_love_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/teacher_love_list";
        ...
        if(loginVo == null) {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/teacher_love_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
            // 파라미터 세팅
    ...
    @RequestMapping(value = "/senior/mypage/teacher_love_view.do", method = RequestMethod.GET)
    public String senior_teacher_love_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/teacher_love_view";
        ...
        if (loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/teacher_love_view.do?lecture_apy_idx=" + lecture_apy_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url = "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/teacher_love_view.do?lecture_apy_idx=" + lecture_apy_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
            // 신청 정보
    ...
    @RequestMapping(value = "/senior/mypage/teacher_love_view.do", method = RequestMethod.POST)
    public String senior_teacher_love_view_proc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", "/ssem/senior/mypage/teacher_love_view_ok.do?lecture_apy_idx=" + lectureVo.getLecture_apy_idx());
    ...
    @RequestMapping(value = "/senior/mypage/teacher_love_view_ok.do", method = RequestMethod.GET)
    public String senior_teacher_love_view_ok(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/teacher_love_view_ok";
        ...
        if (loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/teacher_love_view_ok.do?lecture_apy_idx=" + lecture_apy_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url = "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/teacher_love_view_ok.do?lecture_apy_idx=" + lecture_apy_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping("/senior/mypage/teacher_history_list.do")
    public String senior_teacher_hisotry_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/teacher_history_list";
        ...
        if(loginVo == null) {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/teacher_history_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
            // 파라미터 세팅
    ...
    @RequestMapping("/senior/mypage/hope_study_list.do")
    public String senior_hope_study_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/hope_study_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/hope_study_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/hope_study_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/hope_study_insert.do", method = RequestMethod.GET)
    public String senior_hope_study_inscr(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/hope_study_insert";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/hope_study_insert.do?hope_study_idx=" + hope_study_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/hope_study_insert.do?hope_study_idx=" + hope_study_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/hope_study_insert.do", method = RequestMethod.POST)
    public String senior_hope_study_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", "/ssem/senior/mypage/hope_study_list.do");
    ...
    @RequestMapping(value = "/senior/mypage/hope_study_cancel.do", method = RequestMethod.POST)
    public String senior_hope_study_cancel(final MultipartHttpServletRequest multiRequest,
                                          @ModelAttribute("hopeStudyVo") HopeStudyVo hopeStudyVo,
                                          BindingResult bindingResult,
                                          Model model,
                                          SessionStatus status)  throws Exception {
    ...
    @RequestMapping("/senior/mypage/teach_apply_list.do")
    public String senior_teach_apply_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/teach_apply_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/teach_apply_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/teach_apply_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return  "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/teach_apply_insert.do", method = RequestMethod.GET)
    public String senior_teach_apply_inscr(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/teach_apply_insert";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/teach_apply_insert.do?teach_study_idx=" + teach_study_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/teach_apply_insert.do?teach_study_idx=" + teach_study_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/teach_apply_insert.do", method = RequestMethod.POST)
    public String senior_teach_apply_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", "/ssem/senior/mypage/teach_apply_list.do");
                model.addAttribute("altmsg", "수정되었습니다.");
            }
        } catch (Exception e) {
            model.addAttribute("msg", "alterBack");
    ...
    @RequestMapping(value = "/senior/mypage/teach_apply_cancel.do", method = RequestMethod.POST)
    public String senior_teach_apply_cancel(final MultipartHttpServletRequest multiRequest,
                                           @ModelAttribute("teachStudyVo") TeachStudyVo teachStudyVo,
                                           BindingResult bindingResult,
                                           Model model,
                                           SessionStatus status)  throws Exception {
    ...
    @RequestMapping("/senior/mypage/together_study_list.do")
    public String senior_together_study_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/together_study_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/together_study_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/together_study_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return  "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/together_study_insert.do", method = RequestMethod.GET)
    public String senior_together_study_inscr(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/together_study_insert";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/together_study_insert.do?join_study_idx=" + join_study_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/together_study_insert.do?join_study_idx=" + join_study_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/together_study_insert.do", method = RequestMethod.POST)
    public String senior_together_study_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", "/ssem/senior/mypage/together_study_list.do");
                model.addAttribute("altmsg", "수정되었습니다.");
            }
        } catch (Exception e) {
            model.addAttribute("msg", "alterBack");
    ...
    @RequestMapping(value = "/senior/mypage/together_study_cancel.do", method = RequestMethod.POST)
    public String senior_together_study_cancel(final MultipartHttpServletRequest multiRequest,
                                              @ModelAttribute("hopeStudyVo") JoinStudyVo joinStudyVo,
                                              BindingResult bindingResult,
                                              Model model,
                                              SessionStatus status)  throws Exception {
    ...
    @RequestMapping("/senior/mypage/person_book_list.do")
    public String senior_person_book_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/person_book_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/person_book_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/person_book_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/person_book_insert.do", method = RequestMethod.GET)
    public String senior_person_book_inscr(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/person_book_insert";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/person_book_insert.do?person_book_apy_idx=" + person_book_apy_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/person_book_insert.do?person_book_apy_idx=" + person_book_apy_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/person_book_insert.do", method = RequestMethod.POST)
    public String senior_person_book_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", "/ssem/senior/mypage/person_book_list.do");
                model.addAttribute("altmsg", "수정되었습니다.");
    ...
    @RequestMapping(value = "/senior/mypage/person_book_cancel.do", method = RequestMethod.POST)
    public String senior_person_book_cancel(final MultipartHttpServletRequest multiRequest,
                                           @ModelAttribute("personBookApyVo") PersonBookApyVo personBookApyVo,
                                           BindingResult bindingResult,
                                           Model model,
                                           SessionStatus status)  throws Exception {
    ...
    @RequestMapping("/senior/mypage/person_reg_list.do")
    public String senior_person_reg_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/person_reg_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/person_reg_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/person_reg_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/person_reg_insert.do", method = RequestMethod.GET)
    public String senior_person_reg_inscr(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/person_reg_insert";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/person_reg_insert.do?person_book_reg_idx=" + person_book_reg_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/person_reg_insert.do?person_book_reg_idx=" + person_book_reg_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/person_reg_insert.do", method = RequestMethod.POST)
    public String senior_person_reg_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                if(cmm.isFtype_flag()){
                    ...
                    model.addAttribute("msg", "alterloc");
                    model.addAttribute("locurl", "/ssem/senior/mypage/person_reg_list.do");
                    model.addAttribute("altmsg", "수정되었습니다.");
    ...
    @RequestMapping(value = "/senior/mypage/person_reg_cancel.do", method = RequestMethod.POST)
    public String senior_person_reg_cancel(final MultipartHttpServletRequest multiRequest,
                                          @ModelAttribute("personBookRegVo") PersonBookRegVo personBookRegVo,
                                          BindingResult bindingResult,
                                          Model model,
                                          SessionStatus status)  throws Exception {
    ...
    @RequestMapping("/senior/mypage/instrum_rental_list.do")
    public String senior_instrum_rental_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/instrum_rental_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/instrum_rental_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/instrum_rental_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/instrum_rental_insert.do", method = RequestMethod.GET)
    public String senior_instrum_rental_inscr(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/instrum_rental_insert";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/instrum_rental_insert.do?instrum_apy_idx=" + instrum_apy_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/instrum_rental_insert.do?instrum_apy_idx=" + instrum_apy_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/instrum_rental_insert.do", method = RequestMethod.POST)
    public String senior_instrum_rental_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", "/ssem/senior/mypage/instrum_rental_list.do");
                model.addAttribute("altmsg", "수정되었습니다.");
            }
        } catch (Exception e) {
            model.addAttribute("msg", "alterBack");
    ...
    @RequestMapping(value = "/senior/mypage/instrum_rental_cancel.do", method = RequestMethod.POST)
    public String senior_instrum_rental_cancel(final MultipartHttpServletRequest multiRequest,
                                              @ModelAttribute("instrumApyVo") InstrumApyVo instrumApyVo,
                                              BindingResult bindingResult,
                                              Model model,
                                              SessionStatus status)  throws Exception {
    ...
    @RequestMapping("/senior/mypage/room_rental_list.do")
    public String senior_room_rental_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/room_rental_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/room_rental_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/room_rental_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/room_rental_view.do", method = RequestMethod.GET)
    public String senior_room_rental_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/room_rental_view";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/room_rental_view.do?rental_fty_apy_idx=" + rental_fty_apy_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/room_rental_view.do?rental_fty_apy_idx=" + rental_fty_apy_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping("/senior/mypage/instrum_donation_list.do")
    public String senior_instrum_donation_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/instrum_donation_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/instrum_donation_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/instrum_donation_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/instrum_donation_insert.do", method = RequestMethod.GET)
    public String senior_instrum_donation_inscr(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/instrum_donation_insert";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/instrum_donation_insert.do?instrum_dnt_idx=" + instrum_dnt_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/instrum_donation_insert.do?instrum_dnt_idx=" + instrum_dnt_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/instrum_donation_insert.do", method = RequestMethod.POST)
    public String senior_instrum_donation_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                if(cmm.isFtype_flag()){
                    ...
                    model.addAttribute("msg", "alterloc");
                    model.addAttribute("locurl", "/ssem/senior/mypage/instrum_donation_list.do");
                    model.addAttribute("altmsg", "수정되었습니다.");
    ...
    @RequestMapping(value = "/senior/mypage/instrum_donation_cancel.do", method = RequestMethod.POST)
    public String senior_instrum_donation_cancel(final MultipartHttpServletRequest multiRequest,
                                                @ModelAttribute("instrumDntVo") InstrumDntVo instrumDntVo,
                                                BindingResult bindingResult,
                                                Model model,
                                                SessionStatus status)  throws Exception {
    ...
    @RequestMapping("/senior/mypage/online_counsel_list.do")
    public String senior_online_counsel_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/online_counsel_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/online_counsel_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/online_counsel_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/online_counsel_insert.do", method = RequestMethod.GET)
    public String senior_online_counsel_inscr(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/online_counsel_insert";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/online_counsel_insert.do?self_counsel_idx=" + self_counsel_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/online_counsel_insert.do?self_counsel_idx=" + self_counsel_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
            ...
            if(!selfCounselVo.getReg_id().equals(loginVo.getUser_id())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/online_counsel_insert.do");
                model.addAttribute("altmsg", "잘못된 접근입니다.<br/>계속적인 시도 시 사용에 제약이 있을 수 있습니다.");
                ret_url =  "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/online_counsel_insert.do", method = RequestMethod.POST)
    public String senior_online_counsel_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", "/ssem/senior/mypage/online_counsel_list.do");
                model.addAttribute("altmsg", "수정되었습니다.");
            }
        } catch (Exception e) {
            model.addAttribute("msg", "alterBack");
    ...
    @RequestMapping(value = "/senior/mypage/online_counsel_cancel.do", method = RequestMethod.POST)
    public String senior_online_counsel_cancel(final MultipartHttpServletRequest multiRequest,
                                              @ModelAttribute("selfCounselVo") SelfCounselVo selfCounselVo,
                                              BindingResult bindingResult,
                                              Model model,
                                              SessionStatus status)  throws Exception {
    ...
    @RequestMapping("/senior/mypage/circle_reg_list.do")
    public String senior_circle_reg_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/circle_reg_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/circle_reg_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/circle_reg_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/circle_reg_insert.do", method = RequestMethod.GET)
    public String senior_circle_reg_inscr(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/circle_reg_insert";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/circle_reg_insert.do?club_idx=" + club_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/circle_reg_insert.do?club_idx=" + club_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/circle_reg_insert.do", method = RequestMethod.POST)
    public String senior_circle_reg_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/circle_reg_insert.do?club_idx=" + clubVo.getClub_idx());
                model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
                ret_url =  "common/message";
            } else {
    ...
    @RequestMapping(value = "/senior/mypage/circle_reg_cancel.do", method = RequestMethod.POST)
    public String senior_circle_reg_cancel(final MultipartHttpServletRequest multiRequest,
                                          @ModelAttribute("clubVo") ClubVo clubVo,
                                          BindingResult bindingResult,
                                          Model model,
                                          SessionStatus status)  throws Exception {
    ...
    @RequestMapping("/senior/mypage/survey_list.do")
    public String senior_survey_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/survey_list";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/survey_list.do");
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if(!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/survey_list.do");
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/survey_view.do", method = RequestMethod.GET)
    public String senior_survey_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "senior/mypage/survey_view";
        ...
        if(loginVo == null) {
            model.addAttribute("msg", "alterloc");
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/senior/mypage/survey_view.do?svy_idx=" + svy_idx);
            model.addAttribute("altmsg", "로그인 후 사용가능합니다.");
            ret_url =  "common/message";
        } else {
            ...
            if (!"Y".equals(loginVo.getMypage_check())) {
                model.addAttribute("msg", "alterloc");
                model.addAttribute("locurl", Constants.youth_pwd_confirm_url + "?return_url=/senior/mypage/survey_view.do?svy_idx=" + svy_idx);
                model.addAttribute("altmsg", "비밀번호 확인 후 조회가 가능합니다.");
                return "common/message";
            }
    ...
    @RequestMapping(value = "/senior/mypage/act_print.do", method = RequestMethod.GET)
    public String senior_act_print(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
