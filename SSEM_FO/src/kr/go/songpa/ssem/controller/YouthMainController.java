 ...
 */
@Controller
public class YouthMainController extends CommonController {
    @Autowired
    ...
    public YouthMainController() {
    }

    @RequestMapping(value = "/youth/main/main.do", method = RequestMethod.GET)
    public String youth_main(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "youth/main/main";

        // 메인 이미지 배너
        List<MainImgVo> mainImgList = mainService.selectMainImgYouthList();
        ...
        // 추천 프로그램 리스트
        List<LectureVo> lectureList = mainService.selectLectureYouthMainList();
        ...
        // 팝업 리스트
        List<PopupVo> popupList = mainService.selectPopupMainList("J");
    ...
    @RequestMapping(value = "/youth/main/teacher_reg.do", method = RequestMethod.GET)
    public String youth_teacher_reg(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "youth/main/teacher_reg";
        ...
        if(loginVo == null) {
            ...
            model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/youth/main/teacher_reg.do");
    ...
    @RequestMapping(value = "/youth/main/teacher_reg.do", method = RequestMethod.POST)
    public String youth_teacher_reg_inpro(final MultipartHttpServletRequest multiRequest,
    ...
    @RequestMapping(value = "/youth/main/privacy.do", method = RequestMethod.GET)
    public String youth_main_privacy(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "youth/main/privacy";

        return ret_url;
    }

    @RequestMapping(value = "/youth/main/terms.do", method = RequestMethod.GET)
    public String youth_main_terms(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "youth/main/terms";

        return ret_url;
    }

    @RequestMapping(value = "/youth/main/mail.do", method = RequestMethod.GET)
    public String youth_main_mail(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "youth/main/mail";

        return ret_url;
    }

    @RequestMapping(value = "/youth/main/copyright.do", method = RequestMethod.GET)
    public String youth_main_copyright(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "youth/main/copyright";

        return ret_url;
    }

    @RequestMapping(value = "/youth/main/sitemap.do", method = RequestMethod.GET)
    public String youth_main_sitemap(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "youth/main/sitemap";

        return ret_url;
    }

    @RequestMapping(value = "/youth/main/family_site.do", method = RequestMethod.GET)
    public String youth_main_family_site(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "youth/main/family_site";
