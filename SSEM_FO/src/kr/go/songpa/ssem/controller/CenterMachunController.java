 ...
 */
@Controller
public class CenterMachunController extends CommonController {
    ...
    public CenterMachunController() {
    }

    @RequestMapping(value = "/machuncenter/main/main.do", method = RequestMethod.GET)
    public String machun_main(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/main/main";
        int group_idx = appService.selectGroupIdx("마천청소년센터");
        // 송파청소년센터 메인 배너
        BannerVo bannerVo = new BannerVo();
        bannerVo.setGubun("MACHUN");
    ...
    @RequestMapping(value = "/machuncenter/intro/intro.do", method = RequestMethod.GET)
    public String machun_intro(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/intro/intro";

        return ret_url;
    }

    @RequestMapping("/machuncenter/program/program_list.do")
    public String machun_program_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/program/program_list";
    ...
    @RequestMapping(value = "/machuncenter/program/program_view.do", method = RequestMethod.GET)
    public String machun_program_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/program/program_view";
    ...
    @RequestMapping(value = "/machuncenter/program/love_insert.do", method = RequestMethod.POST)
    public String machun_program_love_inproc(final MultipartHttpServletRequest multiRequest,
        ...
        try {
            ...
            if(loginVo == null) {
                ...
                model.addAttribute("locurl", Constants.youth_login_url + "?return_url=/machuncenter/program/program_view.do?lecture_idx=" + loveVo.getLecture_idx());
                ...
                if(count == 0) {
                    ...
                    model.addAttribute("locurl", "/ssem/machuncenter/program/program_view.do?lecture_idx=" + loveVo.getLecture_idx());
                } else {
    ...
    @RequestMapping(value = "/machuncenter/biz/major.do", method = RequestMethod.GET)
    public String machun_biz_major(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/biz/major";

        return ret_url;
    }

    @RequestMapping(value = "/machuncenter/fac/intro.do", method = RequestMethod.GET)
    public String machun_fac_intro(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/fac/intro";

        return ret_url;
    }

    @RequestMapping("/machuncenter/news/notice_list.do")
    public String machun_news_notice_list(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/news/notice_list";
    ...
    @RequestMapping(value = "/machuncenter/news/notice_view.do", method = RequestMethod.GET)
    public String machun_news_notice_view(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/news/notice_view";
    ...
    @RequestMapping(value = "/machuncenter/main/privacy.do", method = RequestMethod.GET)
    public String main_privacy(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/main/privacy";

        return ret_url;
    }

    @RequestMapping(value = "/machuncenter/main/terms.do", method = RequestMethod.GET)
    public String main_terms(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/main/terms";

        return ret_url;
    }

    @RequestMapping(value = "/machuncenter/main/mail.do", method = RequestMethod.GET)
    public String main_mail(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/main/mail";

        return ret_url;
    }

    @RequestMapping(value = "/machuncenter/main/copyright.do", method = RequestMethod.GET)
    public String main_copyright(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        String ret_url = "machuncenter/main/copyright";
