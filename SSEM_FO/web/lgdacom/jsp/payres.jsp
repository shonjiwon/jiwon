...
<%@ page import="kr.go.songpa.ssem.model.PayVo" %>
...
request.setCharacterEncoding("euc-kr");
	...
	*/
    ...
    String configPath = "F:/lgdacom";  //토스페이먼츠에서 제공한 환경파일("/conf/lgdacom.conf,/conf/mall.conf") 위치 지정.
   	...
   	if( !isInitOK ) {
        ...
        return;
   		...
   		try{
			...
			xpay.Set("LGD_HASHDATA", LGD_HASHDATA);
