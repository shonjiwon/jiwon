    ...
    <div class="sub_con st_1"><!-- sub_con -->
        ...
        <div class="wrap">
                                        ...
                                        <div class="text_box col_10 col_sm_6 fs_20 fs_md_24">
                                            ...
                                            <div class="text_con mt_20">
                                                <div class="clearfix">
                                                    ...
                                                    <a href="/ssem/youth/program/lecture_view.do?lecture_idx=${lectureVo.lecture_idx}" class="btn btn_color_1 btn_small float_right">바로가기</a>
                                                </div>
                                            </div>
                    ...
                    <li class="table bg_color_2">
                        <div class="td">
                            <div class="pt_30 pb_20 mr_20 clearfix">
                                ...
                                <a href="/ssem/youth/magnet/teach_can_insert.do?hope_study_idx=${hopeStudyVo.hope_study_idx}" class="btn btn_auto btn_color_1 btn_small float_right mt_md_10">가르칠 수 있어요</a>
                            </div>
            ...
            <div class="btn_box mt_50 mb_100 pb_30 fs_20 t_right t_md_center">
                <a href="/ssem/youth/magnet/study_hope_list.do" class="btn btn_short fs_auto t_center">목록</a>
            </div>
        </div>
        </section>
        <!--팝업-->
        <div class="popup_wrap_st2" id="popup1">
            <div class="popup_box">
                <div class="popup_con">
                    ...
                    <form name="frm" id="frm" action="/ssem/youth/magnet/study_hope_join_insert.do" method="post" enctype="multipart/form-data">
                    ...
                    <div class="table_box fs_18 fs_md_24 mt_60"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">참여하기의 이름, 휴대폰 번호</caption>
                            <colgroup>
                                <col width="25%">
                                <col width="75%">
                            </colgroup>
                    ...
                    <div class="agree_box "><!--agree_box-->
                        ...
                        <ul class="ul_list_dot fs_18 fs_md_24  mb_20 tc_sub">
                            <li>개인정보의 수집ㆍ이용 목적  :  이배우고 싶어요 신청 및 관련 안내</li>
