    ...
    <div class="sub_con st_1"><!-- sub_con -->
        ...
        <div class="wrap">
            ...
            <div class="program_info_box st_2">
                <div class="top clearfix mb_20 mb_md_40">
                    ...
                    <div class="float_right float_md_none fs_20 fs_md_22 mt_5 t_right t_md_left mt_md_10 clearfix_after">
                        ...
                        <form name="frm_love" id="frm_love" action="/ssem/youth/program/lecture_love_insert.do" method="post" enctype="multipart/form-data">
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_center">
                <a href="/ssem/youth/program/lecture_list.do" class="btn btn_long btn_big t_center mr_15">목록</a>
                <c:choose>
