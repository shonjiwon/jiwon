            ...
            <div class="location_nav float_left"><!-- location_nav -->
                ...
                <ul>+
                    ...
                    <li class="deapth_1">
                        ...
                        <ul>
                            <li><a href="#">온라인 캠퍼스</a></li>
                            <li><a href="#">통합프로그램신청</a></li>
                            <li><a href="#">마그넷스쿨</a></li>
                            <li><a href="#">교육지원송파쌤</a></li>
                            <li><a href="#">송파쌤</a></li>
                            <li><a href="#">온라인 코칭쌤</a></li>
                        </ul>
                    </li>
        ...
        <div class="wrap">
            <div class="row">
                <div class="col_8 offset_2 t_center">
                    <h3 class="mt_100 mb_50 tit font_sc dp_ind">통합프로그램신청 (미리보기)</h3>
                </div>
            </div>
        </div>
        <div class="wrap">
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_center">
                ...
                <c:choose>
                    ...
                    <c:when test="${lectureVo.status_code eq '3'}">
                        <a href="#none" class="btn btn_long btn_big btn_color_1 t_centermr_20 ">신청하기</a>
                    </c:when>
                    <c:when test="${lectureVo.status_code eq '8'}">
