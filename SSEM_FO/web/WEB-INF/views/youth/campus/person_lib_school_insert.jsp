    ...
    <div class="sub_con st_2"><!-- sub_con -->
        ...
        <div class="tab_box fs_20 fs_md_26"><!-- tab_box -->
            ...
            <ul class="tab tab_7"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                ...
                <li class="tab_item"><a href="/ssem/youth/campus/person_lib_book_list.do" title="선택">인물도서 목록</a></li>
                ...
                <li class="tab_item on"><a href="/ssem/youth/campus/person_lib_school_list.do">찾아가는 인물도서</a></li>
        ...
        <h4 class="tit2 mt_100 mb_30">찾아가는 인물도서 열람신청</h4>
        <form name="frm" id="frm" action="/ssem/youth/campus/person_lib_school_insert.do" method="post" enctype="multipart/form-data">
            ...
            <div class="wrap">
                <h5 class="fs_24 fs_md_30 fw_600 fw_md_500 ptb_20">찾아가는 인물도서 정보</h5>
                ...
                <h5 class="fs_24 fs_md_30 fw_600 fw_md_500 ptb_20 mt_20 clearfix">
                    <span class="dp_inb float_left">찾아가는 인물도서 신청</span>
                    <span class="dp_inb float_right fs_18 fs_md_24 tc_point">*필수입력</span>
                </h5>
                <div class="table_box fs_18 fs_md_24"><!--table_box-->
                    <table class="table">
                        <caption class="text_hide">찾아가는 신청자 정보의 이름, 휴대폰번호, 신청인원, 신청기관 단체명, 열람희망 일시, 열람희망 장소</caption>
                        <tbody>
                        <tr>
                ...
                <div class="agree_box mt_60 fs_18 fs_md_24 fs_20"><!--agree_box-->
                    ...
                    <ul class="ul_list_dot mb_20 tc_sub">
                        <li>개인정보의 수집ㆍ이용 목적  :  인물도서 신청 및 관련 안내</li>
                ...
                <div class="btn_box mt_50 mb_100 pb_30 t_center">
                    <a href="#none" class="btn btn_long btn_big btn_color_2 t_centermr_20 mr_15" id="btn_submit">열람 신청하기</a>
                    <a href="/ssem/youth/campus/person_lib_school_view.do?person_book_idx=${personBookVo.person_book_idx}" class="btn btn_long btn_big t_center">취소하기</a>
                </div>
            </div>
        </form>
    </div>
