...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_2"><!-- sub_con -->
        ...
        <div class="wrap">
            <div class="profile_box mb_30">
                <div class="p_tit_box">
                    <h4 class="p_tit">이달의 인물도서 ${monthInfo.year}년 ${monthInfo.month}월</h4>
                    <a href="/ssem/youth/campus/person_lib_month_view.do?person_book_idx=${monthInfo.person_book_idx}" class="more">내용보기</a>
                </div>

                <a href="/ssem/youth/campus/person_lib_month_view.do?person_book_idx=${monthInfo.person_book_idx}">
                <div class="profile_img">
                    <div class="img_box">
                        <c:forEach items="${monthInfo.thumbFileList}" var="thumb" varStatus="status">
                            <img src="${thumb.file_src}" alt="${item.alt_txt}">
                        </c:forEach>
                    </div>
                    <div class="text_box">
                        <div class="date"><span><span class="fs_40 fw_600 font_roboS">${monthInfo.month}</span>월</span></div>
                        <div class="text_wrap">
						<span class="p_book fs_22 fs_md_26 fw_600">
                            ...
                            <p class="p_text fs_34 fs_md_42 font_sc fw_800">${monthInfo.summary}</p>
                        </div>
                    </div>
                </div>
                </a>
        ...
        <form name="frm" id="frm" method="post" action="/ssem/youth/campus/person_lib_month_list.do">
                    ...
                    <c:if test="${fn:length(itemList) == 0}">
                        <div class="img_list_item color_1 col_12">
                            ...
                            <div class="noDate t_center">
                                ...
                                <p  class="mt_30 fs_30"><span class="fw_600">‘이달의 인물도서’</span> 에 대한 검색결과가 없습니다.</p>
                            </div>
                            <!--data : e-->
                        </div>
                    </c:if>
                                ...
                                <section>
                                    <div class="img_box">
                                        <div class="marker_label">
                                            <span class="marker">
                                                <span class="year">${item.year}년</span>
                                                <span class="digit">${item.month}</span>
                                    ...
                                    <div class="text_box">
                                        ...
                                        <div class="item_bottom">
                                            <div class="clearfix">
                                                <span class="fw_600" style="max-width:100% !important;">${item.person}</span>
                                            </div>
                                        </div>
                                    </div>
                                </section>
