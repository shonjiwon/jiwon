    ...
    <div class="sub_con st_2"><!-- sub_con -->
        ...
        <div class="wrap">
            ...
            <ul class="table_list_ul prev_next_page_box fs_18 fs_md_24">
                <c:choose>
                    <c:when test="${personBookVo.prev ne null}">
                        <li class="prev_box">
                            <a href="/ssem/youth/campus/person_lib_live_view.do?person_book_idx=${personBookVo.prev.person_book_idx}">
                                <section class="table">
                ...
                <c:choose>
                    <c:when test="${personBookVo.next ne null}">
                        <li class="next_box">
                            <a href="/ssem/youth/campus/person_lib_live_view.do?person_book_idx=${personBookVo.next.person_book_idx}">
                                <section class="table">
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_right t_md_center">
                <a href="/ssem/youth/campus/person_lib_live_list.do" class="btn btn_short t_center">목록</a>
            </div>
        </div>
    </div>
</div>
