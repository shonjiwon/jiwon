...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_2"><!-- sub_con -->
        ...
        <form name="frm" id="frm" method="post" action="/ssem/youth/campus/person_lib_school_list.do">
                ...
                <div class="img_list_box row mt_45 mt_md_30 pt_10">
                    <c:if test="${fn:length(itemList) == 0}">
                        <div class="img_list_item color_1 col_12">
                            ...
                            <div class="noDate t_center">
                                ...
                                <p  class="mt_30 fs_30"><span class="fw_600">‘찾아가는 인물도서’</span> 에 대한 검색결과가 없습니다.</p>
                            </div>
                            <!--data : e-->
                        </div>
                    </c:if>
                    <c:forEach items="${itemList}" var="item" varStatus="status">
                        <div class="img_list_item color_1 col_3 col_lg_4 col_sm_6">
                            <a href="/ssem/youth/campus/person_lib_school_view.do?person_book_idx=${item.person_book_idx}">
                                <section>
                                    <div class="img_box">
                                    ...
                                    <div class="text_box">
                                        ...
                                        <div class="item_bottom">
                                            <div class="clearfix">
                                                <span class="float_left" style="max-width:100%">인물도서 : ${item.person}</span>
