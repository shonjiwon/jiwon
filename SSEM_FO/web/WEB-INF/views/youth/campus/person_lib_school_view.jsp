...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_2"><!-- sub_con -->
        ...
        <h4 class="tit2 mt_100 mb_50">찾아가는 인물도서</h4>
        <div class="wrap">
            <div class="table_box_ul fs_18 fs_md_24"><!--table_box-->
                <ul>
                    ...
                    <li class="table">
                        ...
                        <div class="td">
                            <c:if test="${personBookVo.movie_url ne '' and personBookVo.movie_url ne null}">
                                <a class="btn btn_small btn_color_2" title="새창" href="${personBookVo.movie_url}" target="_blank">영상 보러가기</a>
                            </c:if>
                        </div>
                    </li>
                    <li class="table">
            ...
            <ul class="table_list_ul prev_next_page_box fs_18 fs_md_24">
                <c:choose>
                    <c:when test="${personBookVo.prev ne null}">
                        <li class="prev_box">
                            <a href="/ssem/youth/campus/person_lib_school_view.do?person_book_idx=${personBookVo.prev.person_book_idx}">
                                <section class="table">
                ...
                <c:choose>
                    <c:when test="${personBookVo.next ne null}">
                        <li class="next_box">
                            <a href="/ssem/youth/campus/person_lib_school_view.do?person_book_idx=${personBookVo.next.person_book_idx}">
                                <section class="table">
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_right t_md_center">
                <a href="/ssem/youth/campus/person_lib_school_insert.do?person_book_idx=${personBookVo.person_book_idx}" class="btn btn_long btn_big btn_color_2 t_centermr_20 mr_15">열람신청</a>
                <a href="/ssem/youth/campus/person_lib_school_list.do" class="btn btn_short t_center">목록</a>
            </div>
