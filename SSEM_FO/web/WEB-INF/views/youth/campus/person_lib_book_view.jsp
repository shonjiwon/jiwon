...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_2"><!-- sub_con -->
        ...
        <h4 class="tit2 mt_100 mb_50">인물도서 목록</h4>
        <div class="wrap">
            ...
            <ul class="table_list_ul prev_next_page_box fs_18 fs_md_24">
                <c:choose>
                    ...
                    <li class="prev_box">
                        <a href="/ssem/youth/campus/person_lib_book_view.do?person_book_idx=${personBookVo.prev.person_book_idx}">
                            <section class="table">
                ...
                <c:choose>
                    <c:when test="${personBookVo.next ne null}">
                        <li class="next_box">
                            <a href="/ssem/youth/campus/person_lib_book_view.do?person_book_idx=${personBookVo.next.person_book_idx}">
                                <section class="table">
                                    <div class="col"><i class="icon_prev_bk">다음</i><span class="screen_md_hide">다음글</span></div>
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_right t_md_center">
                <a href="/ssem/youth/campus/person_lib_book_insert.do?person_book_idx=${personBookVo.person_book_idx}" class="btn btn_color_2 t_centermr_20 mr_15">열람신청</a>
                <a href="/ssem/youth/campus/person_lib_book_list.do" class="btn btn_short t_center">목록</a>
            </div>
        </div>
    </div>
</div>
