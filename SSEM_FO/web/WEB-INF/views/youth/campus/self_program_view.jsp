...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '프로그램 신청 > 진학학습지원센터 > 온라인 캠퍼스 > 미래교육 > 송파쌤');
    ...
    <div class="sub_con st_4"><!-- sub_con -->
        ...
        <div class="tab_box fs_20 fs_md_26"><!-- tab_box -->
            ...
            <ul class="tab tab_4"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                ...
                <li class="tab_item on"><a href="/ssem/youth/campus/self_program_list.do" title="선택">프로그램 신청</a></li>
        ...
        <div class="wrap">
            ...
            <div class="program_info_box">
                <div class="top clearfix mb_20 mb_md_40">
                    ...
                    <form name="frm_love" id="frm_love" action="/ssem/youth/campus/self_love_insert.do" method="post" enctype="multipart/form-data">
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_center">
                <a href="/ssem/youth/campus/self_program_list.do" class="btn btn_long btn_big t_center mr_15">목록</a>
                <c:choose>
