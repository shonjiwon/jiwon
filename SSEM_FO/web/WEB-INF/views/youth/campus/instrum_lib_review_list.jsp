...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <form name="frm" id="frm" method="post" action="/ssem/youth/campus/instrum_lib_review_list.do">
            ...
            <div class="table_img_ul mt_10 fs_18"> <!--table_img_ul-->
                <ul>
                    ...
                    <c:forEach items="${itemList}" var="item" varStatus="status">
                        <li>
                            <a href="/ssem/youth/campus/instrum_lib_review_view.do?instrum_review_idx=${item.instrum_review_idx}">
                                <section class="row">
