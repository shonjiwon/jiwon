...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_2"><!-- sub_con -->
        ...
        <div class="wrap">
            ...
            <div class="table_box fs_18 fs_md_24"><!--table_box-->
                <table class="table">
                    <caption class="text_hide">신청자 정보의 이름, 휴대전화 번호, 신청인원, 단체명, 열람희망 일시, 열람희망 장소</caption>
                    <tbody>
                    <tr>
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_center">
                ...
                <a href="/ssem/youth/campus/person_lib_book_list.do" class="btn btn_long btn_big t_center">확인</a>
            </div>
        </div>
    </div>
</div>
