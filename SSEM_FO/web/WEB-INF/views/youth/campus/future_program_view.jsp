        ...
        <div class="wrap">
            ...
            <div class="program_info_box">
                <div class="top clearfix mb_20 mb_md_40">
                    ...
                    <form name="frm_love" id="frm_love" action="/ssem/youth/campus/future_love_insert.do" method="post" enctype="multipart/form-data">
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_center">
                <a href="/ssem/youth/campus/future_program_list.do" class="btn btn_long btn_big t_center mr_15">목록</a>
                <c:choose>
