...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_2"><!-- sub_con -->
        ...
        <div class="info_tit wrap t_right fs_22">인물도서 : <strong><fmt:formatNumber value="${totalCount}" pattern="##,###"/></strong>명</div>
        <form name="frm" id="frm" method="post" action="/ssem/youth/campus/person_lib_book_list.do">
            ...
            <div class="wrap">
                ...
                <c:if test="${fn:length(itemList) == 0}">
                    <div class="img_list_item color_1 col_12">
                        ...
                        <div class="noDate t_center">
                            ...
                            <p  class="mt_30 fs_30"><span class="fw_600">‘인물도서’</span> 에 대한 검색결과가 없습니다.</p>
                        </div>
                        <!--data : e-->
                    </div>
                </c:if>
                <c:forEach items="${itemList}" var="item" varStatus="status">
                    <div class="img_list_item color_1 col_3 col_lg_4 col_sm_6">
                        <a href="/ssem/youth/campus/person_lib_book_view.do?person_book_idx=${item.person_book_idx}">
                            <section>
                                <div class="img_box">
                                ...
                                <div class="text_box">
                                    ...
                                    <div class="item_bottom">
                                        <div class="clearfix">
                                            <span class="float_left fw_600" style="max-width:100%">${item.person}</span>
                                            <!-- <span class="float_right fw_400"><i class="icon_view_bk mr_5">보기</i><fmt:formatNumber value="${item.cnt}" pattern="##,###"/></span> -->
                                        </div>
                                    </div>
                                </div>
                            </section>
