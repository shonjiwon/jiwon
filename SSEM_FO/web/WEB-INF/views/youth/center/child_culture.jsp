...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '송파어린이문화회관 > 교육지원 > 미래교육 > 송파쌤');
            ...
            <div class="info_box_table st_2 mt_15 fs_18 fs_md_26">
                <div class="col_wrap">
                    <dl>
                        ...
                        <dd>
                            <div class="plr_20">
                                <p class="c_tit_3 t_bef_middot c1 mb_15"><span class="fs_22 fs_md_26">상상마루 체험관</span></p>
                ...
                <div class="col_wrap mt_md_20">
                    <dl>
                        ...
                        <dd>
                            <div class="plr_20">
                                <p class="c_tit_3 t_bef_middot c1 mb_15"><span class="fs_22 fs_md_26">재능개발프로그램</span></p>
            ...
            <div class="info_box_table st_2 mt_15 fs_18 fs_md_26">
                <div class="col_wrap">
                    <dl>
                        ...
                        <dd>
                            <div class="plr_20">
                                <p class="c_tit_3 t_bef_middot c1 mb_15"><span class="fs_22 fs_md_26">공연장</span></p>
                ...
                <div class="col_wrap mt_md_20">
                    <dl>
                        <dt>
                            <img src="/ssem/resources/img/sub/foreverEdu/fec_img_04.png" alt="상담실">
                        </dt>
                        <dd>
                            <div class="plr_20">
                                <p class="c_tit_3 t_bef_middot c1 mb_15"><span class="fs_22 fs_md_26">상담실</span></p>
            ...
            <div class="info_box_table st_2 mt_15 fs_18 fs_md_26">
                <div class="col_wrap">
                    <dl>
                        ...
                        <dd>
                            <div class="plr_20">
                                <p class="c_tit_3 t_bef_middot c1 mb_15"><span class="fs_22 fs_md_26">키즈카페</span></p>
