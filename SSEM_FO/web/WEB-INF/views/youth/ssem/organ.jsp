...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '조직도 > 송파쌤이란? > 미래교육 > 송파쌤');
        ...
        <div class="text_con ">
            ...
            <div class="tab_box fs_20 fs_md_26"><!-- tab_box -->
                ...
                <ul class="tab tab_2"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                    <li  class="tab_item"><a href="/ssem/youth/ssem/vision.do">비전</a></li>
                    <li  class="tab_item on"><a href="/ssem/youth/ssem/organ.do">조직도</a></li>
                </ul>
            </div><!-- tab_box //-->
            <div class="wrap">
                <div class="row">
