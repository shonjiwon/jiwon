...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '배우고 싶어요 > 마그넷스쿨 > 나의 송파쌤 > 미래교육 > 송파쌤');
...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_1 mypage_st"><!-- sub_con -->
        ...
        <div class="mypage_tab_box fs_20 fs_md_26"><!-- mypage_tab : s -->
            ...
            <ul class="tab tab_3">
                <li class="tab_item on"><a href="/ssem/youth/mypage/hope_study_list.do">배우고 싶어요</a></li>
        ...
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <form name="frm_cancel" id="frm_cancel" action="/ssem/youth/mypage/hope_study_cancel.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="hope_study_idx" value="${hopeStudyVo.hope_study_idx}" />
                </form>
                <form name="frm" id="frm" action="/ssem/youth/mypage/hope_study_insert.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="apy_mob_no" id="apy_mob_no" />
                    <input type="hidden" name="hope_study_idx" value="${hopeStudyVo.hope_study_idx}"/>
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">배우고 싶어요 신청의 청원신청, 청원기간, 성명, 휴대폰 번호, 주소, 단체명/인원, 희망강의명, 희망요일, 상세내용, 등록일</caption>
                            <tbody>
                            ...
                            <c:choose>
                                <c:when test="${hopeStudyVo.select_yn ne 'Y'}">
                                    ...
                                    <div class="col_3 t_right">
                                        <a href="/ssem/youth/mypage/hope_study_list.do" class="btn btn_short btn_big ml_md_10">목록</a>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <div class="t_right">
