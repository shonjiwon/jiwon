...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_1 mypage_st"><!-- sub_con -->
        ...
        <form name="frm_cancel" id="frm_cancel" action="/ssem/youth/mypage/circle_reg_cancel.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="club_idx" value="${clubVo.club_idx}"/>
        </form>
        <form name="frm" id="frm" action="/ssem/youth/mypage/circle_reg_insert.do" method="post" enctype="multipart/form-data">
        ...
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <div class="table_box fs_18 fs_md_24"><!--table_box-->
                    <table class="table">
                        <caption class="text_hide">온라인 상담 예약 신청 폼의 신청상태, 동아리명, 분야, 창립일, 소속기관, 회원수, 모임주기 및 요일, 모임장소, 동아리 소개, 주요활동, 제출서류 첨부, 신청일</caption>
                        <tbody>
                ...
                <div class="agree_box mt_60 fs_18 fs_md_24"><!--agree_box-->
                    ...
                    <ul class="ul_list_dot mb_20 tc_sub fw_300">
                        <li>개인정보의 수집ㆍ이용 목적  : 동아리신청 및 관련 안내</li>
                ...
                <div class="btn_box mypage_btn_box mt_50 pb_30 t_center t_md_right">
                    <div class="row">
                        ...
                        <div class="col_3 t_right">
                            <a href="/ssem/youth/mypage/circle_reg_list.do" class="btn btn_short btn_big ml_md_10">목록</a>
                        </div>
                    </div>
                </div>
            </div>
