        ...
        $('#printBtn').click(function(){
            ...
            if ( navigator.platform ) {
                if ( filter.indexOf( navigator.platform.toLowerCase() ) < 0 ) {
                    ...
                    window.open('/ssem/youth/mypage/act_print.do?lecture_apy_idx=${lectureApyVo.lecture_apy_idx}', "PopupWin", 'width=1000px,height=800px,scrollbars=yes');
                }
            }
        });
    });
        ...
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <div class="btn_box mt_50 t_right">
                    ...
                    <a href="/ssem/youth/mypage/attend_list.do" class="btn btn_short btn_big t_center">목록</a>
                </div>
            </div>
        </section>
    </div>
