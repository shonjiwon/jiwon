    ...
    <div class="sub_con st_1 mypage_st"><!-- sub_con -->
        ...
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <form name="frm_cancel" id="frm_cancel" action="/ssem/youth/mypage/instrum_rental_cancel.do" method="post" enctype="multipart/form-data">
                ...
                <form name="frm" id="frm" action="/ssem/youth/mypage/instrum_rental_insert.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="instrum_apy_idx" value="${instrumApyVo.instrum_apy_idx}" />
                    <input type="hidden" name="instrum_idx" value="${instrumApyVo.instrumVo.instrum_idx}" />
                ...
                <div class="table_box fs_18 fs_md_24"><!--table_box-->
                    <table class="table">
                        <caption class="text_hide">신청의 신청 상태, 구분, 단체명, 전화번호, 이메일, 주소, 인원, 대여목적, 부모이름, 부모연락처, 대여수량, 대여기간, 결제금액, 반납일정, 신청일 </caption>
                        <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="fm_cal ml_20" style="display: none;">
                        ...
                        <c:choose>
                            <c:when test="${instrumApyVo.status eq 'A'}">
                                ...
                                <div class="col_3 t_right">
                                    <a href="/ssem/youth/mypage/instrum_rental_list.do" class="btn btn_short btn_big ml_md_10">목록</a>
                                </div>
                            </c:when>
                            <c:otherwise>
                                <div class="t_right">
