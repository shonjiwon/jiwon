    ...
    <div class="sub_con st_1 mypage_st"><!-- sub_con -->
        ...
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <form name="frm_cancel" id="frm_cancel" action="/ssem/youth/mypage/together_study_cancel.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="join_study_idx" value="${joinStudyVo.join_study_idx}" />
                </form>
                <form name="frm" id="frm" action="/ssem/youth/mypage/together_study_insert.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="apy_mob_no" id="apy_mob_no" />
                    <input type="hidden" name="join_study_idx" value="${joinStudyVo.join_study_idx}"/>
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">배우고 싶어요의 청원신청, 청원기간, 희망강의명, 내용, 함께배워요</caption>
                            <tbody>
                    ...
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">신청 정보의 신청자 이름, 휴대폰 번호</caption>
                            <tbody>
                            <tr>
                    ...
                    <div class="btn_box mypage_btn_box mt_50 pb_30 t_center t_md_right">
                        <div class="row">
                            ...
                            <div class="col_3 t_right">
                                <a href="/ssem/youth/mypage/together_study_list.do" class="btn btn_short btn_big ml_md_10">목록</a>
                            </div>
                        </div>
