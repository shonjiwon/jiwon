...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '함께 배워요 > 마그넷스쿨 > 나의 송파쌤 > 미래교육 > 송파쌤');
        ...
        <div class="wrap wrap_md_p_0 clearfix_after">
            <div class="location_nav float_left"><!-- location_nav -->
                ...
                <ul>
                    ...
                    <li class="deapth_1">
                        <a href="#" class="deapth_tit" title="선택">함께배워요</a>
                        <ul>
                            <li><a href="/ssem/youth/mypage/hope_study_list.do">배우고 싶어요</a></li>
                            <li><a href="/ssem/youth/mypage/teach_apply_list.do">가르칠 수 있어요</a></li>
                            <li><a href="/ssem/youth/mypage/together_study_list.do">함께배워요</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- location_nav // -->
    ...
    <div class="sub_con st_1 mypage_st"><!-- sub_con -->
        ...
        <div class="tab_box fs_20 fs_md_26"><!-- tab_box -->
            ...
            <ul class="tab tab_7"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                ...
                <li class="tab_item on"><a href="/ssem/youth/mypage/hope_study_list.do"><span class="tab_middle">마그넷스쿨</span></a></li>
        ...
        <div class="mypage_tab_box fs_20 fs_md_26"><!-- mypage_tab : s -->
            <ul class="tab tab_3">
                <li class="tab_item"><a href="/ssem/youth/mypage/hope_study_list.do">배우고 싶어요</a></li>
                <li class="tab_item"><a href="/ssem/youth/mypage/teach_apply_list.do">가르칠 수 있어요</a></li>
                <li class="tab_item on"><a href="/ssem/youth/mypage/together_study_list.do">함께 배워요</a></li>
            </ul>
        </div><!-- mypage_tab : end -->
        <div class="data_search ptb_30 fs_20 fs_md_26"><!--Data Search-->
            <form name="frm" id="frm" method="post" action="/ssem/youth/mypage/together_study_list.do">
                        ...
                        <div class="col_12 col_md_15 pl_20 pl_md_0 mt_md_20">
                            <div class="data_search_word_box">
                                <div class="fm_inp inp_full">
                                    <input class="inp" title="검색어" id="searchVal" name="searchVal" value="${searchVal}">
                                </div>
                ...
                <div class="table_img_ul st_2 fs_18 mt_15"> <!--table_img_ul-->
                    <ul>
                            ...
                            <li>
                                <section>
                                    ...
                                    <div class="noDate t_center">
                                        ...
                                        <p  class="mt_30 fs_30"><span class="fw_600">‘함께 배워요’</span> 에 대한 검색결과가 없습니다.</p>
                                    </div>
                                    <!--data : e-->
                                </section>
                            </li>
                        ...
                        <c:forEach items="${itemList}" var="item" varStatus="status">
                            ...
                            <li>
                                <a href="/ssem/youth/mypage/together_study_insert.do?join_study_idx=${item.join_study_idx}">
                                    <section class="row">
                                        <div class="text_box col_12 fs_20 fs_md_26">
                                            <div class="text_top">
                                                <div class="plr_20 clearfix">
                                                    <ul class="category_list float_left">
                                                        <li>
                                                            <c:choose>
                                                                <c:when test="${item.hopeStudyVo.close_yn eq 'Y'}">
                                                                    <b>종료</b>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <b>진행중</b>
                                                        ...
                                                        <c:if test="${item.hopeStudyVo.select_yn eq 'Y'}">
                                                    ...
                                                    <div class="dp_inb float_right">
                                                        ...
                                                        <span class="tc_sub">${fn:substring(item.hopeStudyVo.reg_dt, 0, 10)} ~ ${item.hopeStudyVo.close_dt}</span>
                                                    </div>
                                                    <!--2020.11.04 : e-->
                                                </div>
                                            </div>
                                            <div class="text_con">
                                                <div class="plr_40 plr_md_20 pt_20 pt_md_40">
                                                    <div class="title ellip_1 fs_26 fs_md_30">${item.hopeStudyVo.name}</div>
                                                    <p class="ellip_1 tc_sub fw_200 mt_md_40">${item.hopeStudyVo.cont}</p>
                                                </div>
                                            </div>
                                            <div class="text_bottom">
                                                <div class="plr_40 plr_md_20 clearfix ">
                                                    <ul class="info_list float_left">
                                                        <li><b>작성자</b> ${item.hopeStudyVo.apy_name}</li>
                                                        <!--2020.11.04 : s-->
                                                        <!--2020.11.04 : e-->
                                                    </ul>
                                                    <div class="float_right">
                                                        ...
                                                        <!--2020.11.04 : e-->
                                                        <span class="dp_inb va_m">${item.hopeStudyVo.join_cnt}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
