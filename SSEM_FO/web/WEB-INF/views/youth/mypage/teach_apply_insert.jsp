...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '가르칠 수 있어요 > 마그넷스쿨 > 나의 송파쌤 > 미래교육 > 송파쌤');
    ...
    <div class="sub_con st_1 mypage_st"><!-- sub_con -->
        ...
        <div class="mypage_tab_box fs_20 fs_md_26"><!-- mypage_tab : s -->
            ...
            <ul class="tab tab_3">
                ...
                <li class="tab_item on"><a href="/ssem/youth/mypage/teach_apply_list.do">가르칠 수 있어요</a></li>
                <li class="tab_item"><a href="/ssem/youth/mypage/together_study_list.do">함께 배워요</a></li>
            </ul>
        </div><!-- mypage_tab : end -->
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <form name="frm_cancel" id="frm_cancel" action="/ssem/youth/mypage/teach_apply_cancel.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="teach_study_idx" value="${teachStudyVo.teach_study_idx}" />
                </form>
                <form name="frm" id="frm" action="/ssem/youth/mypage/teach_apply_insert.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="apy_mob_no" id="apy_mob_no" />
                    <input type="hidden" name="teach_study_idx" value="${teachStudyVo.teach_study_idx}"/>
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">배우고 싶어요의 청원신청, 청원기간, 희망강의명, 함께배워요</caption>
                            <tbody>
                    ...
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">신청 정보의 강사명, 휴대폰 번호, 교육분야, 강의명, 강좌계획, 강의 계획서, 강사이력</caption>
                            <tbody>
                            <tr>
                    ...
                    <div class="btn_box mypage_btn_box mt_50 pb_30 t_center t_md_right">
                        <div class="row">
                            ...
                            <div class="col_3 t_right">
                                <a href="/ssem/youth/mypage/teach_apply_list.do" class="btn btn_short btn_big ml_md_10">목록</a>
                            </div>
                        </div>
                    </div>
                </form>
