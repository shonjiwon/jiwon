...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '프로그램 신청 > 프로그램 확인 > 나의 송파쌤 > 미래교육 > 송파쌤');
...
<div class="contents" id="contents">
    ...
    -->
    <form method="post" name="pay_result" id="pay_result" action="/ssem/youth/mypage/program_payment.do" enctype="multipart/form-data">
    ...
    <form method="post" name="pay_cancel" id="pay_cancel" action="/ssem/youth/mypage/program_payment_cancel.do" enctype="multipart/form-data">
        <input type="hidden" name="CST_PLATFORM" value="service"/>
        <input type="hidden" name="CST_MID" value="${LGD_MID}"/>
    ...
    <form method="post" name="apy_cancel" id="apy_cancel" action="/ssem/youth/mypage/program_apy_cancel.do" enctype="multipart/form-data">
        <input type="hidden" name="lecture_apy_idx" value="${lectureApyVo.lecture_apy_idx}"/>
        <input type="hidden" name="lecture_idx" value="${lectureVo.lecture_idx}"/>
    </form>
    <div class="sub_con st_1 mypage_st"><!-- sub_con -->
        ...
        <div class="mypage_tab_box fs_20 fs_md_26"><!-- mypage_tab : s -->
            ...
            <ul class="tab tab_3">
                <li class="tab_item on"><a href="/ssem/youth/mypage/program_list.do">프로그램 신청</a></li>
                ...
                <div class="btn_box mt_50 t_right">
                    <c:choose>
                        <c:when test="${lectureApyVo.pay_status eq '1'}">
                            ...
                            <a href="/ssem/youth/mypage/program_list.do" class="btn btn_short btn_big t_center">목록</a>
    ...
    <div class="popup_wrap_st3" id="popup3">
        <div class="popup_box">
            ...
            <form method="post" name="apy_refund" id="apy_refund" action="/ssem/youth/mypage/program_apy_refund.do" enctype="multipart/form-data">
                <input type="hidden" name="lecture_apy_idx" value="${lectureApyVo.lecture_apy_idx}"/>
                <input type="hidden" name="lecture_idx" value="${lectureVo.lecture_idx}"/>
