...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_1 mypage_st"><!-- sub_con -->
        ...
        <form name="frm" id="frm" method="post" action="/ssem/youth/mypage/program_list.do">
                    ...
                    <ul>
                        <li class="t_head fs_20">
                            <section class="table">
                                ...
                                <div class="col wid_170">교육기관</div>
                        ...
                        <c:forEach items="${itemList}" var="item" varStatus="status">
                            ...
                            <li class="wa_ba">
                                    ...
                                    <section class="table">
                                        ...
                                        <div class="col wid_170">${item.lectureVo.group.name}</div>
                                        <div class="col wid_100">${item.lectureVo.part_name}</div>
                                        <!-- <div class="col wid_220"><p class="ellip_1">${item.lectureVo.name}</p></div> -->
                                        <div class="col wid_220">
                                            <a href="/ssem/youth/mypage/program_view.do?lecture_apy_idx=${item.lecture_apy_idx}"><p class="ellip_1 link_line">${item.lectureVo.name}</p></a>
                                        </div>
