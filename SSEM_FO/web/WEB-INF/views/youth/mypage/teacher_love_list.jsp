...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_1 mypage_st"><!-- sub_con -->
        ...
        <div class="data_search ptb_30 fs_20 fs_md_26 fs_md_24"><!--Data Search-->
            <form name="frm" id="frm" method="post" action="/ssem/youth/mypage/teacher_love_list.do">
                        ...
                        <c:forEach items="${itemList}" var="item" varStatus="status">
                            ...
                            <li class="wa_ba">
                                <c:choose>
                                    ...
                                    <a href="/ssem/youth/mypage/teacher_love_view_ok.do?lecture_apy_idx=${item.lecture_apy_idx}">
                                    </c:when>
                                    <c:otherwise>
                                    <a href="/ssem/youth/mypage/teacher_love_view.do?lecture_apy_idx=${item.lecture_apy_idx}">
                                    </c:otherwise>
                                </c:choose>
                                    <section class="table">
