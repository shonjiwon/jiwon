...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '비밀번호 확인 > 미래교육 > 송파쌤');
...
<div class="contents" id="contents">
            ...
            <div class="location_nav float_left"><!-- location_nav -->
                ...
                <ul>
                    ...
                    <li class="deapth_1">
                        ...
                        <ul>
                            <li><a href="/ssem/youth/mypage/pwd_confirm.do">비밀번호 확인</a></li>
    ...
    <div class="sub_con st_1"><!-- sub_con -->
        ...
        <form name="frm" id="frm" method="post" action="/ssem/youth/mypage/pwd_confirm.do">
                    ...
                    <div class="password_ok_wrap">
                        ...
                        <div class="password_box">
                            ...
                            <div class="fs_20 fs_md_26 mt_30">
                                <a href="javascript:goSubmit();" class="btn fs_auto btn_color_1">확인</a>
                            </div>
                        </div>
                    </div>
                </div>
