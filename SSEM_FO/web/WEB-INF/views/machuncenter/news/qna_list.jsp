...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '고객광장 > 고객지원 > 마천청소년센터 > 송파쌤');
    ...
    <div class="sub_con st_1"><!-- sub_con -->
        <div class="brd_line_box fs_20 fs_md_26 mt_10 mt_md_90"><!-- tab_box -->
            ...
            <ul class="tab tab_4"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                <li class="tab_item"><a href="/ssem/machuncenter/news/notice_list.do">공지사항</a></li>
                <li class="tab_item on"><a href="/ssem/machuncenter/news/qna_list.do">고객광장</a></li>
            </ul>
        </div><!-- tab_box //-->
