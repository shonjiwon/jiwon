...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '마천청소년센터 > 송파쌤');
...
<div class="contents" id="contents">
            ...
            <c:forEach items="${bannerList}" var="banner" varStatus="status">
                <div class="mv_item">
                    ...
                    <div class="mv_text_box lh_16 ">
                        <h3 class="mv_sub_tit fs_60 fs_md_76 lh_12 font_scd">청소년 문화 소통 공간</h3>
                        <p class="fs_26 fs_md_28 mt_10">  스스로 성장하는 청소년<br> 마천청소년센터</p>
                    </div>
                    </a>
                </div>
            </c:forEach>
    ...
    <div class="mch_wrap">
        ...
        <div class="wrap por pt_100 pt_md_80"><!--program_box_wrap-->
            <h3 class="tit fw_600 font_dxlp"><span class=" dp_b fs_48 fs_md_50 lh_10">MACHEON YOUTH CENTER</span></h3>
            <p class="tit_sub t_center mt_10 fw_200 fs_18 fs_md_30 wb_ka">마천청소년센터는 항상 학생들의 진로를 고민합니다.</p>
            <div class="row maru_box mt_50 mt_md_30 mb_35">
                <div class="color_1 col_6 col_md_12 mb_md_40">
                    <!-- id : SSEM-C-01-02-01  -->
                    <a href="/ssem/machuncenter/intro/intro.do">
                        <section>
                            <div class="pi_img_box por">
                                <img src="/ssem/resources/img/main/macheon/about_bg.jpg" alt="책읽고있는 이미지">
                            ...
                            <div class="pi_text_box ptb_40 plr_40 ptb_md_40 plr_md_20">
                                <h4 class="pi_tit fs_26 fs_md_36 mb_10">
                                    <span class="">마천청소년센터란</span>
                                </h4>
                                <p class="pi_data fs_18 fs_md_26 fw_200 lh_16">
                                    청소년들을 위한, 청소년들의 공간!<br>
                                    마천청소년센터를 소개합니다.
                                </p>
                            </div>
                        </section>
                ...
                <div class="color_1 col_6 col_md_12 mb_md_40">
                    <!-- id : SSEM-C-01-04-01  -->
                    <a href="/ssem/machuncenter/program/program_list.do">
                        <section>
                            <div class="pi_img_box por">
                                <img src="/ssem/resources/img/main/macheon/program_bg.jpg" alt="노트북 이미지">
    ...
    <div class="mch_wrap_st2 pb_100 bg_color_2">
        <div class="wrap pt_100 pt_md_0 fs_20 pb_30">
            <div class="row">
                        ...
                        <div class="table">
                            <div class="col">
                                <div class="bg_color_1 ptb_50">
                                    <a href="/ssem/machuncenter/biz/major.do">
                                        <section>
                            ...
                            <div class="col">
                                <div class="bg_color_1 ptb_50">
                                    <a href="/ssem/machuncenter/fac/intro.do">
                                        <section>
                ...
                <div class="col_6 col_md_12 pr_50 pr_md_0 mt_md_50">
                    <div class="notice_list_box fs_20 fs_md_28">
                        ...
                        <ul>
                            <c:forEach items="${noticeList}" var="notice" varStatus="status">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <li class="nlb_item">
                                            <a href="/ssem/machuncenter/news/notice_view.do?bbs_detail_idx=${notice.bbs_detail_idx}">
                                                <section>
                                                    <div class="table">
                                                        <div class="col _tit"><p class="ellip_1">${notice.title}</p></div>
                                                        <div class="col _date">${fn:substring(notice.reg_dt, 0, 10)}</div>
                        ...
                        <a href="/ssem/machuncenter/news/notice_list.do" class="more_btn"><i class="icon_more">more</i></a>
                    </div>
                </div>
            </div>
        </div>
