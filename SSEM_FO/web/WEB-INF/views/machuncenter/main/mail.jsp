...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '이메일주소 무단수집거부 > 마천청소년센터 > 송파쌤');
            ...
            <div class="location_nav _right"><!-- location_nav -->
                ...
                <ul class="deapth_cnt2">
                    ...
                    <li class="deapth_1">
                        ...
                        <ul>
                            <li><a href="/ssem/machuncenter/main/privacy.do">개인정보처리방침</a></li>
                            <li><a href="/ssem/machuncenter/main/mail.do">이메일주소 무단수집거부</a></li>
                            <li><a href="/ssem/machuncenter/main/copyright.do">저작권정책</a></li>
                            <li><a href="/ssem/machuncenter/main/terms.do">이용약관</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- location_nav // -->
