...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '이메일주소 무단수집거부 > 송파진로직업체험지원센터 > 온라인 캠퍼스 > 송파쌤');
            ...
            <div class="location_nav _right"><!-- location_nav -->
                ...
                <ul class="deapth_cnt2">
                    ...
                    <li class="deapth_1">
                        ...
                        <ul>
                            <li><a href="/ssem/dream/main/privacy.do">개인정보처리방침</a></li>
                            <li><a href="/ssem/dream/main/mail.do">이메일주소 무단수집거부</a></li>
                            <li><a href="/ssem/dream/main/copyright.do">저작권정책</a></li>
                            <li><a href="/ssem/dream/main/terms.do">이용약관</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- location_nav // -->
