...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '공지사항 > 꿈마루 소식 > 송파진로직업체험지원센터 > 온라인 캠퍼스 > 송파쌤');
    ...
    <div class="sub_con st_1"><!-- sub_con -->
        ...
        <div class="wrap">
            ...
            <ul class="table_list_ul prev_next_page_box fs_18 fs_md_24">
                <c:choose>
                    <c:when test="${bbsDetailVo.prev ne null}">
                        <li class="prev_box">
                            <a href="/ssem/dream/news/notice_view.do?bbs_detail_idx=${bbsDetailVo.prev.bbs_detail_idx}">
                                <section class="table">
                ...
                <c:choose>
                    <c:when test="${bbsDetailVo.next ne null}">
                        <li class="next_box">
                            <a href="/ssem/dream/news/notice_view.do?bbs_detail_idx=${bbsDetailVo.next.bbs_detail_idx}">
                                <section class="table">
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_right t_md_center">
                <a href="/ssem/dream/news/notice_list.do" class="btn btn_short t_center">목록</a>
            </div>
        </div>
    </div>
</div>
