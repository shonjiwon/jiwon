...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '공지사항 > 고객지원 > 잠실청소년센터 > 송파쌤');
...
<div class="contents" id="contents">
    <div class="sub_visual jamsil_st_5"><!-- sub_visual -->
        <div class="wrap por">
            ...
            <div class="location_nav float_left"><!-- location_nav -->
                ...
                <ul class="deapth_cnt2">
                    ...
                    <li class="deapth_1">
                        ...
                        <ul>
                            <li><a href="/ssem/jamsilcenter/news/notice_list.do">공지사항</a></li>
                            <li><a href="/ssem/jamsilcenter/news/qna_list.do">고객광장</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- location_nav // -->
    ...
    <div class="sub_con st_1"><!-- sub_con -->
        <div class="brd_line_box fs_20 fs_md_26 mt_10 mt_md_90"><!-- tab_box -->
            ...
            <ul class="tab tab_4"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                <li class="tab_item on"><a href="/ssem/jamsilcenter/news/notice_list.do">공지사항</a></li>
                <li class="tab_item"><a href="/ssem/jamsilcenter/news/qna_list.do">고객광장</a></li>
            </ul>
        </div><!-- tab_box //-->
        ...
        <div class="wrap">
            ...
            <ul class="table_list_ul prev_next_page_box fs_18 fs_md_24">
                <c:choose>
                    <c:when test="${bbsDetailVo.prev ne null}">
                        <li class="prev_box">
                            <a href="/ssem/jamsilcenter/news/notice_view.do?bbs_detail_idx=${bbsDetailVo.prev.bbs_detail_idx}">
                                <section class="table">
                ...
                <c:choose>
                    <c:when test="${bbsDetailVo.next ne null}">
                        <li class="next_box">
                            <a href="/ssem/jamsilcenter/news/notice_view.do?bbs_detail_idx=${bbsDetailVo.next.bbs_detail_idx}">
                                <section class="table">
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_right t_md_center">
                <a href="/ssem/jamsilcenter/news/notice_list.do" class="btn btn_short t_center">목록</a>
            </div>
        </div>
    </div>
</div>
