...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_1"><!-- sub_con -->
        ...
        <form name="frm" id="frm" method="post" action="/ssem/jamsilcenter/news/notice_list.do">
            ...
            <div class="table_list_ul mt_50 fs_18 fs_md_24" id="moTable">
                <ul>
                    ...
                    <c:forEach items="${itemList}" var="item" varStatus="status">
                        ...
                        <li>
                            <a href="/ssem/jamsilcenter/news/notice_view.do?bbs_detail_idx=${item.bbs_detail_idx}">
                                <section class="table">
