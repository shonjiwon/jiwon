    ...
    <div class="sub_con st_1"><!-- sub_con -->
        <div class="brd_line_box fs_20 fs_md_26 mt_10 mt_md_90"><!-- tab_box -->
            ...
            <ul class="tab tab_4"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                <li  class="tab_item on"><a href="/ssem/songpacenter/news/notice_list.do" title="선택">공지사항</a></li>
                <li  class="tab_item"><a href="/ssem/songpacenter/news/qna_list.do">고객광장</a></li>
            </ul>
        </div><!-- tab_box //-->

        <h3 class="mt_100 mt_mb_80 mb_50 tit font_sc">공지사항</h3>
        <form name="frm" id="frm" method="post" action="/ssem/songpacenter/news/notice_list.do">
            ...
            <div class="table_list_ul mt_50 fs_18 fs_md_24" id="moTable">
                <ul>
                    ...
                    <c:forEach items="${itemList}" var="item" varStatus="status">
                        ...
                        <li>
                            <a href="/ssem/songpacenter/news/notice_view.do?bbs_detail_idx=${item.bbs_detail_idx}">
                                <section class="table">
