...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_1"><!-- sub_con -->
        ...
        <form name="frm" id="frm" method="post" action="/ssem/songpacenter/program/program_list.do">
                ...
                <div class="list_box row mt_25 mt_md_30 pt_10">
                    ...
                    <c:forEach items="${itemList}" var="item" varStatus="status">
                        <div class="list_item col_3 col_lg_4 col_sm_6">
                            <a href="/ssem/songpacenter/program/program_view.do?lecture_idx=${item.lecture_idx}">
                                <section>
                                    <div class="img_box">
