...
<div class="footer_wrap">
	<div id="footer" class="wd_ka youth">
		...
		<div class="wrap">
			<div class="f_table">
				<h1 class="f_logo vm_a">
					<a href="#"><img src="/ssem/resources/img/common/macheon/macheon_logo_footer.png" alt="마천청소년센터"></a>
				</h1>

				<div class="f_info_box">
					<div class="f_link">
						<div><a href="/ssem/machuncenter/main/privacy.do">개인정보 처리방침</a></div>
						<div class="line_md_none"><a href="/ssem/machuncenter/main/terms.do">이용약관</a></div><br class="screen_hide screen_md_show ">
						<div><a href="/ssem/machuncenter/main/mail.do">이메일주소무단수집거부</a></div>
						<div><a href="/ssem/machuncenter/main/copyright.do">저작권정책</a></div>
					</div>
					<div class="f_info">
						<span class="mb_10 line_none tc_w">서울시 송파구 성내천로319 (마천1동 325-5)</span><br>
						<span class="mb_10">사업자번호. 416-82-84711</span>
						<span class="mb_10 line_none">대표자. 백준종</span><br>
						<span class="mb_10">TEL. (02) 443-0100</span>
						<span class="mb_10 line_md_none">FAX. (02) 3402-0435</span><br class="screen_hide screen_md_show ">
						<span class="mb_10 line_none">E-MAIL. 4430100@mcyouth.or.kr</span><br>
					</div>
				</div>
			</div>
		</div>
