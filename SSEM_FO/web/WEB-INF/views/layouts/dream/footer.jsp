...
<div id="footer" class="wd_ka maru">
	<div class="f_top">
		<div class="wrap">
	...
	<div class="wrap">
		<div class="f_table">
			<h1 class="f_logo">
				<a href="#"><img src="/ssem/resources/img/common/ggoom_logo_footer.png" alt="송파쌤"></a>
			</h1>

			<div class="f_info_box">
				<div class="f_info">
					<span class="line_none mb_10 t_addr">서울시 송파구 마천로35길 12. 송파구 평생학습원 1층</span><br>
					<span class="line_md_none mb_10">상호 : 송파진로체험지원센터(기업가정신)</span><br class="screen_hide screen_md_show ">
					<span class='line_none mb_md_10'>센터장 : 김범준</span><br>
					<span>TEL : (02)6713-2394~7</span><span>E-MAIL : ggoommaru@naver.com</span>
				</div>
			</div>
		</div>
		<div class="top_btn">
