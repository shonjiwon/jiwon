...
<div class="footer_wrap">
	<div id="footer" class="wd_ka">
		...
		<div class="wrap">
			<div class="f_table">
				<h1 class="f_logo">
					<a href="/ssem/senior/main/main.do"><img src="/ssem/resources/img/common/logo_footer.png" alt="송파쌤"></a>
				</h1>

				<div class="f_info_box">
					<div class="f_link">
						<div><a href="/ssem/senior/main/privacy.do">개인정보 처리방침</a></div>
						<div class="line_md_none"><a href="/ssem/senior/main/terms.do">이용약관</a></div><br class="screen_hide screen_md_show ">
						<div><a href="/ssem/senior/main/mail.do">이메일주소무단수집거부</a></div>
						<div><a href="/ssem/senior/main/copyright.do">저작권정책</a></div>
					</div>
					<div class="f_info">
