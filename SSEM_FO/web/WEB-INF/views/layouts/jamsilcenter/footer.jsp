...
<div class="footer_wrap">
	<div id="footer" class="wd_ka youth">
		<div class="f_top">
			<div class="wrap">
		...
		<div class="wrap">
			<div class="f_table">
				<h1 class="f_logo pt_60 pt_md_0">
					<a href="#"><img src="/ssem/resources/img/common/jamsil/jamsil_logo_footer.png" alt="구립잠실청소년센터"></a>
				</h1>

				<div class="f_info_box">
					<div class="f_link">
						<div><a href="/ssem/jamsilcenter/main/privacy.do">개인정보 처리방침</a></div>
						<div class="line_md_none"><a href="/ssem/jamsilcenter/main/terms.do">이용약관</a></div><br class="screen_hide screen_md_show ">
						<div><a href="/ssem/jamsilcenter/main/mail.do">이메일주소무단수집거부</a></div>
						<div><a href="/ssem/jamsilcenter/main/copyright.do">저작권정책</a></div>
					</div>
					<div class="f_info">
						<span class="mb_10 line_md_none">서울시 송파구 올림픽로 8길 22(잠실동) </span>
						<span class="mb_10 line_none">사업자번호 : 613-82-80771</span><br>

						<span class="mb_10 mt_10 line_md_none"><span class="tc_w mr_5 mt_md_0 line_md_none">구립잠실청소년센터</span></span> <br class="screen_hide screen_md_show ">
						<span class="mb_10">TEL. (02)2039-1530 </span>
						<span class="mb_10 line_md_none">FAX. (02)2039-0259 </span><br class="screen_hide screen_md_show ">
						<span class="mb_10 line_none">E-MAIL. jamsilyouth@naver.com</span><br>

						<span class="mb_10 mt_10 line_md_none"><span class="tc_w mr_5 mt_md_0 line_md_none">잠실본동송파키움센터</span></span><br class="screen_hide screen_md_show ">
						<span class="mb_10">TEL. (02)6925-7044 </span>
						<span class="mb_10 line_md_none">FAX. (02)6925-6984 </span><br class="screen_hide screen_md_show ">
						<span class="mb_10 line_none">E-MAIL. jamsilkium@naver.com</span>
					</div>
				</div>
			</div>
		</div>
