		...
		<div class="wrap">
			<div class="f_table">
				<h1 class="f_logo pt_60 pt_md_0">
					<a href="#"><img src="/ssem/resources/img/common/songpa/songpa_logo_footer.png" alt="구립 송파청소년미래센터"></a>
				</h1>

				<div class="f_info_box">
					<div class="f_link">
						<div><a href="/ssem/futurecenter/main/privacy.do">개인정보 처리방침</a></div>
						<div class="line_md_none"><a href="/ssem/futurecenter/main/terms.do">이용약관</a></div><br class="screen_hide screen_md_show ">
						<div><a href="/ssem/futurecenter/main/mail.do">이메일주소무단수집거부</a></div>
						<div><a href="/ssem/futurecenter/main/copyright.do">저작권정책</a></div>
					</div>
					<div class="f_info">
						<span class="mb_10 line_none"><span class="tc_w">서울시 송파구 동남로28길 40</span></span><br>
						<span class="mb_10">고유번호 : 305-82-90591</span>
						<span class="mb_10 line_none">TEL : (02)6951-1825 </span><br>
						<span class="mb_10 line_md_none">FAX : (02)6951-1826</span><br class="screen_hide screen_md_show ">
						<span class="mb_10 line_none">E-MAIL : sp.mirae@spmirae.or.kr</span>
					</div>
				</div>
			</div>
		</div>
