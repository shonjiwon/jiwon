...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <form name="frm" id="frm" action="/ssem/senior/magnet/study_hope_insert.do" method="post" enctype="multipart/form-data">
            ...
            <section class="text_con fs_18 fs_md_26 mt_100">
                <div class="wrap ">
                    ...
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">배우고 싶어요 신청폼의 청원기간, 성명, 휴대폰 번호, 주소, 희망강의명, 희망요일, 상세내용 </caption>
                            <tbody>
                            <tr>
                    ...
                    <div class="btn_box mt_50 mb_100 pb_30 t_center">
                        <a href="/ssem/senior/magnet/study_hope_list.do" class="btn btn_long btn_big t_center mr_15">취소</a>
