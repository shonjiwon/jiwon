        ...
        <section class="text_con fs_18 fs_md_26 mt_0 mt_md_50 pb_100 mb_15">
            <div class="sub_main_list_wrap st_3 pb_md_50">
                <div class="wrap por">
                    ...
                    <a href="/ssem/senior/program/lecture_list.do?searchKind4=41" class="more_btn ani">+ 더보기</a>
                </div>
            </div>
            <form name="frm" id="frm" method="post" action="/ssem/senior/magnet/study_hope_list.do">
            ...
            <div class="wrap">
                ...
                <div class="info_tit wrap t_left fs_22">
                ...
                <div class="table_img_ul st_2 fs_18"> <!--table_img_ul-->
                    <ul>
                        ...
                        <c:forEach items="${itemList}" var="item" varStatus="status">
                            <li>
                                <a href="/ssem/senior/magnet/study_hope_view.do?hope_study_idx=${item.hope_study_idx}">
                                    <section class="row">
                ...
                <div class="col_4 col_lg_24">
                    <div class="btn_box mt_30 t_right">
                        <a href="/ssem/senior/magnet/study_hope_insert.do" class="btn btn_short t_center fs_auto">글쓰기</a>
                    </div>
                </div>
