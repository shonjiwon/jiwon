...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '이용안내 > 마그넷스쿨 > 마그넷스쿨 > 송파쌤');
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <div class="tab_box fs_20 fs_md_26"><!-- tab_box -->
            ...
            <ul class="tab tab_3"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                <li class="tab_item on"><a href="/ssem/senior/magnet/intro.do">이용안내</a></li>
            ...
            <div class="wrap">
                ...
                <div class="row ">
                    ...
                    <div class="col_2 col_md_3 btn_full t_right mt_90 fs_md_20">
                        <a href="/ssem/senior/magnet/study_hope_list.do" class="btn btn_small fs_auto btn_auto va_m btn_round"><i class="icon_plus_b mr_5 screen_lg_hide dp_xxs_inb">배우고 싶어요 이동</i> <span class="screen_xxs_hide">배우고 싶어요</span> </a>
                    </div>
                </div>
