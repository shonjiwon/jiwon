...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <form name="frm" id="frm" action="/ssem/senior/magnet/teach_can_insert.do" method="post" enctype="multipart/form-data">
            ...
            <section class="text_con fs_18 fs_md_26 mt_100">
                <div class="wrap ">
                    ...
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">가르칠 수 있어요 신청폼의 강사명, 휴대폰 번호, 교육분야, 강의명, 강좌계획, 강의계획서, 강사이력 </caption>
                            <tbody>
                            <tr>
                    ...
                    <div class="btn_box mt_50 mb_100 pb_30 t_center">
                        <a href="/ssem/senior/magnet/study_hope_view.do?hope_study_idx=${teachStudyVo.hope_study_idx}" class="btn btn_long btn_big t_center  mr_15">취소</a>
