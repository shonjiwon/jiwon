...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <form name="frm" id="frm" method="post" action="/ssem/senior/magnet/study_share_list.do">
                ...
                <div class="img_list_box row mt_45 mt_md_30 pt_10">
                    ...
                    <c:forEach items="${itemList}" var="item" varStatus="status">
                        <div class="img_list_item color_1 col_3 col_lg_4 col_sm_6">
                            <a href="/ssem/senior/magnet/study_share_view.do?channel_study_idx=${item.channel_study_idx}">
                                <section>
                                    <div class="img_box">
