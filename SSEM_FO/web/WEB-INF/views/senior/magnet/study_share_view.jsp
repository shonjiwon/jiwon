...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '배움 공유채널 > 마그넷스쿨 > 평생교육 > 송파쌤');
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <div class="tab_box fs_20 fs_md_26"><!-- tab_box -->
            ...
            <ul class="tab tab_3"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                ...
                <li class="tab_item"><a href="/ssem/senior/magnet/study_hope_list.do">배우고 싶어요</a></li>
                <li class="tab_item on"><a href="/ssem/senior/magnet/study_share_list.do">배움 공유채널</a></li>
            </ul>
        </div><!-- tab_box //-->
        ...
        <div class="wrap">
            ...
            <ul class="table_list_ul prev_next_page_box fs_18 fs_md_24">
                <c:choose>
                    <c:when test="${channelStudyVo.prev ne null}">
                        <li class="prev_box">
                            <a href="/ssem/senior/magnet/study_share_view.do?channel_study_idx=${channelStudyVo.prev.channel_study_idx}">
                                <section class="table">
                ...
                <c:choose>
                    <c:when test="${channelStudyVo.next ne null}">
                        <li class="next_box">
                            <a href="/ssem/senior/magnet/study_share_view.do?channel_study_idx=${channelStudyVo.next.channel_study_idx}">
                                <section class="table">
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_right t_md_center">
                <a href="/ssem/senior/magnet/study_share_list.do" class="btn btn_short t_center">목록</a>
            </div>
        </div>
    </div>
</div>
