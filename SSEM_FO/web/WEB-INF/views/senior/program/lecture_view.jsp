        ...
        <div class="wrap">
            ...
            <div class="program_info_box st_2">
                <div class="top clearfix mb_20 mb_md_40">
                    <p class="title fs_30 fw_600 float_left float_md_none">${lectureVo.name}</p>
                    <div class="float_right float_md_none fs_20 fs_md_22 mt_5 t_right t_md_left mt_md_10 clearfix_after">
                        ...
                        <c:if test="${lectureVo.qty_open_yn ne 'N'}">
                            ...
                            <span class="va_m tc_1 fw_600"><c:out value="${lectureVo.online_qty - lectureVo.online_can_qty}" /></span>
                            <span class="va_m fw_600"> / <c:out value="${lectureVo.online_qty + lectureVo.tel_qty + lectureVo.visit_qty}" /></span>
                            <span class="va_m">명 (대기자 ${lectureVo.wait_qty - lectureVo.wait_can_qty} / ${lectureVo.wait_qty}명)</span>
                        </c:if>
                        <c:choose>
                            <c:when test="${lectureVo.love_self_yn eq 'Y'}">
                                <a href="#none" class="btn like_btn ml_10 float_md_right" id="btn_love"><i class="icon_heart_line on" title="활성화">하트</i> <span class="count">${lectureVo.love_cnt}</span></a>
                            </c:when>
                            <c:otherwise>
                                <a href="#none" class="btn like_btn ml_10 float_md_right" id="btn_love"><i class="icon_heart_line" title="비활성화">하트</i> <span class="count">${lectureVo.love_cnt}</span></a>
                            </c:otherwise>
                        </c:choose>
                        <form name="frm_love" id="frm_love" action="/ssem/senior/program/lecture_love_insert.do" method="post" enctype="multipart/form-data">
                ...
                <div>
                    <div class="catalogue_box">
                        ...
                        <span class="item">${lectureVo.group.name}</span>
                    </div>
                    <div class="catalogue_box">
                ...
                <ul class="row mt_40">
                    ...
                    <li class="col_4 col_md_6"><span><b class="fw_400">교육시간 :</b> ${lectureVo.dt_str} ${lectureVo.start_time}~${lectureVo.end_time}</span></li>
                    <li class="col_4 col_md_6"><span><b class="fw_400">수강료 :</b> <fmt:formatNumber value="${lectureVo.fee}" pattern="##,###"/>원</span></li>
                    <li class="col_4 col_md_6"><span><b class="fw_400">접수기간 :</b><br> ${fn:substring(lectureVo.reg_start_st, 2, 16)} ~ ${fn:substring(lectureVo.reg_end_dt, 2, 16)}</span></li>
                    <li class="col_4 col_md_6"><span><b class="fw_400">접수방법 :</b> ${lectureVo.reg_method_str}</span></li>
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_center">
                <a href="/ssem/senior/program/lecture_list.do" class="btn btn_long btn_big t_center mr_15">목록</a>
                <c:choose>
                    ...
                    <c:when test="${lectureVo.status_code eq '2'}">
                        <a href="/ssem/senior/program/lecture_insert.do?lecture_idx=${lectureVo.lecture_idx}" class="btn btn_long btn_big btn_color_1 t_centermr_20 ">신청하기</a>
                    </c:when>
                    <c:when test="${lectureVo.status_code eq '3'}">
                        <a href="/ssem/senior/program/lecture_insert.do?lecture_idx=${lectureVo.lecture_idx}" class="btn btn_long btn_big btn_color_1 t_centermr_20 ">신청하기</a>
                    </c:when>
        ...
        <div class="popup_box">
            ...
            <div class="popup_con">
                ...
                <div class="table_box t_center mt_30">
                    <table class="st_2">
                        <caption class="text_hide">강사이력의 이름, 성별, 강의만족도, 전문분야, 주요경력</caption>
                        <colgroup>
                            <col width="24%">
                            <col>
                            <col width="24%">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <p class="mlr_20 t_left">
                                    ...
                                    * 강의 만족도는 강의에 참여해 주신 교육생들의 평가 만족도 입니다.
                                </p>
                            </td>
                        </tr>
                        <tr>
