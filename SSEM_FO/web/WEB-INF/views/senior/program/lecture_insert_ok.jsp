...
<script type="text/javascript">
    ...
    function goMyPage(fee_type) {
        if(fee_type === 'F') {
            // 무료
            modalMsg("수강신청 내용은 마이페이지에서 확인 가능합니다.", 'locurl', "/ssem/senior/mypage/program_list.do");
        } else {
            // 유료
            modalMsg("수강료는 마이페이지에서 결제 가능하며, 강의 신청일을 포함한 <br/>2일 이내에 미결제시 자동 예약 취소됩니다.", 'locurl', "/ssem/senior/mypage/program_list.do");
        }
    }
...
<div class="contents" id="contents">
    ...
    -->
    <form method="post" name="pay_result" id="pay_result" action="/ssem/senior/program/lecture_pay_ok.do" enctype="multipart/form-data">
        ...
        <div class="popup_box wid_995">
            ...
            <div class="popup_con">
                ...
                <div class="table_box t_center">
                    <table class="st_3">
                        <caption class="text_hide">감면내용</caption>
                        <colgroup>
                            <col width="10%">
                            <col width="">
                            <col width="20%">
