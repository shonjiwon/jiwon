...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <div class="wrap">
            ...
            <form name="frm" id="frm" action="/ssem/senior/program/lecture_insert.do" method="post" enctype="multipart/form-data">
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_center">
                <a href="/ssem/senior/program/lecture_view.do?lecture_idx=${lectureVo.lecture_idx}" class="btn btn_long btn_big t_center mr_15">취소</a>
        ...
        <div class="popup_box">
            ...
            <div class="popup_con">
                <div class="table_box t_center">
                    <table class="st_2">
                        <caption class="text_hide">강의장소의 교육장소, 주소, 연락처 안내</caption>
                        <colgroup>
                            <col width="24%">
                            <col width="76%">
                        </colgroup>
