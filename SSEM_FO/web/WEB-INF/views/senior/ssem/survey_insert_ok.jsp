    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <div class="wrap">
            <div class="completion_box t_center">
                ...
                <a href="/ssem/senior/mypage/survey_list.do" class="btn mt_15">마이페이지</a>
            </div>
            ...
            <div class="btn_box mt_50 mb_100 pb_30 t_center">
                <a href="/ssem/senior/mypage/survey_list.do" class="btn btn_long btn_big t_center mr_20">설문조사 참여 보기</a>
                <a href="/ssem/senior/ssem/survey_list.do" class="btn btn_long btn_big t_center">확인</a>
            </div>
        </div>
    </div>
</div>
