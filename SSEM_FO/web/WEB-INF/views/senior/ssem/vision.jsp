...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '비전 > 송파쌤이란 > 송파쌤 > 평생교육 > 송파쌤');
        ...
        <div class="text_con ">
            ...
            <div class="tab_box fs_20 fs_md_26"><!-- tab_box -->
                ...
                <ul class="tab tab_2"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                    <li  class="tab_item on"><a href="/ssem/senior/ssem/vision.do">비전</a></li>
                    <li  class="tab_item"><a href="/ssem/senior/ssem/organ.do">조직도</a></li>
                </ul>
            </div><!-- tab_box //-->
            ...
            <div class="wrap fw_300 fs_20  fs_md_24 ls_75 li_16">
                ...
                <div class="greeting_box">
                    <div class="gb_text">
                        <p class="tc_5 fw_700 fs_38">인사말씀</p>
                ...
                <p class="mt_30 mt_md_40 mb_md_110">앞으로도 송파구가 <b class="fw_500">세상에서 가장 큰 학교</b>가 될 수 있도록 최선을 다하겠습니다. <br>
                감사합니다.</p>
