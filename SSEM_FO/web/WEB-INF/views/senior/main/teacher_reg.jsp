...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '강사신청 > 평생교육 > 송파쌤');
    ...
    <div class="sub_con st_1 mypage_st"><!-- sub_con -->
        ...
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <form name="frm" id="frm" action="/ssem/senior/main/teacher_reg.do" method="post" enctype="multipart/form-data">
                    ...
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">회원 기본 정보의 신청자 이름, 휴대폰 번호, 성별, 생년월일, 이메일, 사진첨부 </caption>
                            <tbody>
                            <tr>
                    ...
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">등록 신청폼의 교육분야, 전문분야, 학력 및 주요경력, 취득자격, 강사이력 </caption>
                            <tbody>
                            <tr>
                    ...
                    <div class="btn_box mypage_btn_box mt_50 pb_30 t_center">
                        ...
                        <a href="/ssem/senior/main/main.do" class="btn btn_long btn_big btn_md_auto ml_10 ml_md_0">신청 취소</a>
                    </div>
                </form>
            </div>
        </section>
