...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '저작권정책 > 평생교육 > 송파쌤');
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <div class="wrap text_con fs_20 fs_md_26 pb_100 mb_15">
            ...
            <div class="btn_box t_center mt_50">
                <a href="http://www.law.go.kr/LSW/lsSc.do?query=%EC%A0%80%EC%9E%91%EA%B6%8C%EB%B2%95" target="_blank" class="btn bnt_round  btn_color_5">저작권법 자세히 보기</a>
                <a href="http://www.kogl.or.kr/index.do" target="_blank" class="btn bnt_round  btn_color_5">공공누리 바로가기</a>
            </div>
        </div>
    </div>
</div>
