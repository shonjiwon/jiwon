...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5 mypage_st"><!-- sub_con -->
        ...
        <div class="data_search ptb_30 fs_20  fs_md_26 fs_md_24"><!--Data Search-->
            <form name="frm" id="frm" method="post" action="/ssem/senior/mypage/person_reg_list.do">
                ...
                <div class="table_list_ul mt_10 fs_18 fs_lg_16 fs_md_24" id="moTable">
                    <ul>
                        ...
                        <c:forEach items="${itemList}" var="item" varStatus="status">
                            ...
                            <li class="wa_ba">
                                <a href="/ssem/senior/mypage/person_reg_insert.do?person_book_reg_idx=${item.person_book_reg_idx}">
                                    <section class="table">
