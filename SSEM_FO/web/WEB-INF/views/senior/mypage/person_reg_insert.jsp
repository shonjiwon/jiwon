...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '인물도서 등록 신청 > 인물도서관 > 나의 송파쌤 > 평생교육 > 송파쌤');
...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5 mypage_st"><!-- sub_con -->
        ...
        <div class="mypage_tab_box fs_20 fs_md_26"><!-- mypage_tab : s -->
            ...
            <ul class="tab tab_2">
                <li class="tab_item"><a href="/ssem/senior/mypage/person_book_list.do">열람 신청</a></li>
                <li class="tab_item on"><a href="/ssem/senior/mypage/person_reg_list.do">인물도서 등록 신청</a></li>
            </ul>
        </div><!-- mypage_tab : end -->
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <!--2020.11.04:e-->
                <form name="frm_cancel" id="frm_cancel" action="/ssem/senior/mypage/person_reg_cancel.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="person_book_reg_idx" value="${personBookRegVo.person_book_reg_idx}" />
                </form>
                <form name="frm" id="frm" action="/ssem/senior/mypage/person_reg_insert.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="person_book_reg_idx" value="${personBookRegVo.person_book_reg_idx}" />
                    ...
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">등록 신청 정보의 분류, 성별, 연령대, 주소, 전화번호, 이메일, 사진등록, 대표경력, 소개글</caption>
                            <tbody>
                            <tr>
                                <!--2020.11.04:s-->
                            ...
                            <c:choose>
                                <c:when test="${personBookRegVo.status eq 'A'}">
                                    ...
                                    <div class="col_3 t_right">
                                        <a href="/ssem/senior/mypage/person_reg_list.do" class="btn btn_short btn_big ml_md_10">목록</a>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <div class="t_right">
