    ...
    <div class="sub_con st_5 mypage_st"><!-- sub_con -->
        ...
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <form name="frm_cancel" id="frm_cancel" action="/ssem/senior/mypage/online_counsel_cancel.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="self_counsel_idx" value="${selfCounselVo.self_counsel_idx}" />
                </form>
                <form name="frm" id="frm" action="/ssem/senior/mypage/online_counsel_insert.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="self_counsel_idx" value="${selfCounselVo.self_counsel_idx}" />
                    ...
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">상담 예약 신청 폼의 예약 상태, 희망 상담유형, 희망 상담일, 통화 상담일, 통화 가능시간, 신청자 메모, 신청일, 상담예약일시</caption>
                            <tbody>
                            ...
                            <c:choose>
                                <c:when test="${selfCounselVo.status eq 'A'}">
                                    ...
                                    <div class="col_3 t_right">
                                        <a href="/ssem/senior/mypage/online_counsel_list.do" class="btn btn_short btn_big ml_md_10">목록</a>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <div class="t_right">
