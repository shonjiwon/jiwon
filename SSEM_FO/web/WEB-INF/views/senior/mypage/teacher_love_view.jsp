    ...
    <div class="sub_con st_5 mypage_st"><!-- sub_con -->
        ...
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <form name="frm" id="frm" method="post" action="/ssem/senior/mypage/teacher_love_view.do" enctype="multipart/form-data">
                        ...
                        <li class="table">
                            ...
                            <div class="td">
                                <div class="mtb_10">
                                    ...
                                    <label class="fm_rd act_uiRdCh mr_20">
                                        <input type="radio" name="score" value="6"><span>6</span>
                                    </label>
                                    <label class="fm_rd act_uiRdCh mr_20">
                                        <input type="radio" name="score" value="7"><span>7</span>
                                    </label>
                                    <label class="fm_rd act_uiRdCh mr_20">
                                        <input type="radio" name="score" value="8"><span>8</span>
                                    </label>
                                    <label class="fm_rd act_uiRdCh mr_20">
                                        <input type="radio" name="score" value="9"><span>9</span>
                                    </label>
                                    <label class="fm_rd act_uiRdCh">
                                        <input type="radio" name="score" value="10"><span>10</span>
                                    </label>
                                </div>
                                <p>
                                    * 수정이 불가하오니 신중히 평가 해주세요.
                                </p>
                            </div>
                        </li>
                        <%--<li class="table">
                            ...
                            <div class="td">
                                <div class="mtb_10">
                                    <p class="mb_15">평가 점수 : 8점 (회원님의 소중한 평가 감사합니다.)</p>
                                    <!--
                                        8 ~ 10 점 : 금
                                        4 ~ 7 점 : 은
                                        1 ~ 3 점 : 동
                                    ...
                                    -->
                                    <img src="/ssem/resources/img/common/bronze.png" alt="동"><br>
                                </div>
                            </div>
                        </li>--%>
                    </ul>
                ...
                <div class="btn_box mt_50 t_right">
                    <button type="button" class="btn btn_long btn_big t_center mr_15 mr_15" id="btn_insert">평가하기</button>
                    <a href="/ssem/senior/mypage/teacher_love_list.do"  class="btn btn_short btn_big t_center">목록</a>
                </div>
            </div>
        </section>
    </div>
