...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '강사 만족도 평가 > 프로그램 확인 > 나의 송파쌤 > 평생교육 > 송파쌤');
    ...
    <div class="sub_con st_5 mypage_st"><!-- sub_con -->
        ...
        <div class="mypage_tab_box fs_20 fs_md_26"><!-- mypage_tab : s -->
            ...
            <ul class="tab tab_3">
                ...
                <li class="tab_item on"><a href="/ssem/senior/mypage/teacher_love_list.do">강사 만족도 평가</a></li>
                <c:if test="${loginVo.teacher_yn eq 'Y'}">
        ...
        <div class="data_search ptb_30 fs_20 fs_md_26 fs_md_24"><!--Data Search-->
            <form name="frm" id="frm" method="post" action="/ssem/senior/mypage/teacher_love_list.do">
                <input type="hidden" name="page" id="page" value="${page}"/>
                <div class="wrap_1250 plr_40">
                    <div class="row_24">
                        <div class="col_6 col_md_12 pr_20 pr_md_10">
                            <!--
                        ...
                        <div class="col_5 col_md_12 pl_md_10">
                            <div class="sel_box sel_full sel_md_short">
                        ...
                        <div class="col_13 pl_20 pl_md_0 col_md_24 line_md_top">
                            <div class="row_15">
                                <div class="col_7">
                                    <div class="fm_cal">
                    ...
                    <div class="row_24 mt_10">
                        <div class="col_7">
                            <div class="sel_box sel_full sel_md_short">
                                <select name="searchKind2" id="searchKind2" title="만족도 평가 여부" class="placeholder">
                                    <option value="">만족도 평가 여부 선택</option>
                                    <option value="Y" <c:if test="${searchKind2 eq 'Y'}">selected="selected"</c:if>>평가</option>
                                    <option value="N" <c:if test="${searchKind2 eq 'N'}">selected="selected"</c:if>>미평가</option>
                                </select>
                            </div>
                        </div>
                        <div class="col_13 col_md_17 offset_4 offset_md_0 data_search_word_box pl_20">
                    ...
                    <ul>
                        <li class="t_head fs_20">
                            <section class="table">
                                ...
                                <div class="col wid_150">강사명</div>
                                <div class="col wid_220">교육기간</div>
                                <div class="col wid_150">만족도 평가</div>
                            </section>
                        </li>
                        <c:if test="${fn:length(itemList) == 0}">
                            <li class="_moInit noDate">
                                <div class="t_center">
                                    ...
                                    <p  class="mt_30 fs_30"><span class="fw_600">‘강사 만족도 평가’</span> 에 대한 검색결과가 없습니다.</p>
                                </div>
                            </li>
                        </c:if>
                        ...
                        <c:forEach items="${itemList}" var="item" varStatus="status">
                            ...
                            <li class="wa_ba">
                                <c:choose>
                                    <c:when test="${item.teacher_love_yn eq 'Y'}">
                                    <a href="/ssem/senior/mypage/teacher_love_view_ok.do?lecture_apy_idx=${item.lecture_apy_idx}">
                                    </c:when>
                                    <c:otherwise>
                                    <a href="/ssem/senior/mypage/teacher_love_view.do?lecture_apy_idx=${item.lecture_apy_idx}">
                                    </c:otherwise>
                                </c:choose>
                                    <section class="table">
                                        ...
                                        <div class="col wid_150">${item.lectureVo.teacher_nm}</div>
                                        <div class="col wid_220">${item.lectureVo.start_dt} ~ ${item.lectureVo.end_dt}</div>
                                        <div class="col wid_150">
                                            <c:choose>
                                                <c:when test="${item.teacher_love_yn eq 'Y'}">평가</c:when>
