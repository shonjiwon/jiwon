    ...
    <div class="sub_con st_5 mypage_st"><!-- sub_con -->
        ...
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <form name="frm_cancel" id="frm_cancel" action="/ssem/senior/mypage/person_book_cancel.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="person_book_apy_idx" value="${personBookApyVo.person_book_apy_idx}" />
                </form>
                <!--2020.11.04 : e-->
                <form name="frm" id="frm" action="/ssem/senior/mypage/person_book_insert.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="person_book_apy_idx" value="${personBookApyVo.person_book_apy_idx}" />
                    ...
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">인물도서 신청경로, 인물도서 제목, 분류, 인물도서 </caption>
                            <tbody>
                            <tr>
                    ...
                    <div class="table_box fs_18 fs_md_24"><!--table_box-->
                        <table class="table">
                            <caption class="text_hide">신청 정보 신청폼의 신청상태, 신청자 이름,  휴대폰 번호, 신청 인원, 단체/학교명, 열람 일시, 확정 일시, 열람 장소</caption>
                            <tbody>
                            <tr>
                                <!--2020.11.04 : s-->
                            ...
                            <c:choose>
                                <c:when test="${personBookApyVo.status eq 'A'}">
                                    ...
                                    <div class="col_3 t_right">
                                        <a href="/ssem/senior/mypage/person_book_list.do" class="btn btn_short btn_big ml_md_10">목록</a>
                                    </div>
                                </c:when>
                                <c:otherwise>
                                    <div class="t_right">
