...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '강의이력 조회 > 프로그램 확인 > 나의 송파쌤 > 평생교육 > 송파쌤');
    ...
    <div class="sub_con st_5 mypage_st"><!-- sub_con -->
        ...
        <div class="mypage_tab_box fs_20 fs_md_26"><!-- mypage_tab : s -->
            <ul class="tab tab_4 on">
                ...
                <li class="tab_item on"><a href="/ssem/senior/mypage/teacher_history_list.do">강의이력 조회</a></li>
            </ul>
        </div><!-- mypage_tab : end -->
        <div class="data_search ptb_30 fs_20 fs_md_26 fs_md_24"><!--Data Search-->
            <form name="frm" id="frm" method="post" action="/ssem/senior/mypage/teacher_history_list.do">
