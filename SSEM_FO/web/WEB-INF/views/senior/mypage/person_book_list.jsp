...
<script type="text/javascript">
    $(document).ready(function() {
        $(document).prop('title', '열람 신청 > 인물도서관 > 나의 송파쌤 > 평생교육 > 송파쌤');
            ...
            <div class="location_nav float_left"><!-- location_nav -->
                ...
                <ul>
                    ...
                    <li class="deapth_1">
                        ...
                        <ul>
                            <li><a href="/ssem/senior/mypage/person_book_list.do">열람신청</a></li>
                            <li><a href="/ssem/senior/mypage/person_reg_list.do">인물도서 등록 신청</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- location_nav // -->
    ...
    <div class="sub_con st_5 mypage_st"><!-- sub_con -->
        ...
        <div class="tab_box fs_20 fs_md_26"><!-- tab_box -->
            ...
            <ul class="tab tab_7"> <!-- tab_3 ~ tab_8 :  min : 3개 ~  max : 8개 -->
                ...
                <li class="tab_item on"><a href="/ssem/senior/mypage/person_book_list.do"><span class="tab_middle">인물도서관</span></a></li>
        ...
        <div class="mypage_tab_box fs_20 fs_md_26"><!-- mypage_tab : s -->
            ...
            <ul class="tab tab_2">
                <li class="tab_item on"><a href="/ssem/senior/mypage/person_book_list.do">열람 신청</a></li>
                <li class="tab_item"><a href="/ssem/senior/mypage/person_reg_list.do">인물도서 등록 신청</a></li>
            </ul>
        </div><!-- mypage_tab : end -->
        <div class="data_search ptb_30 fs_20  fs_md_26 fs_md_24"><!--Data Search-->
            <form name="frm" id="frm" method="post" action="/ssem/senior/mypage/person_book_list.do">
                ...
                <div class="wrap_1250 plr_40">
                    <div class="row_24">
                        <div class="col_8 col_md_12 pr_20">
                            ...
                            <div class="sel_box sel_full">
                                <select id="searchKind2" name="searchKind2" title="신청경로 선택" class="placeholder">
                                    <option value="">전체</option>
                                    <option value="N" <c:if test="${searchKind2 eq 'N'}">selected="selected"</c:if>>인물도서</option>
                                    <option value="S" <c:if test="${searchKind2 eq 'S'}">selected="selected"</c:if>>찾아가는 인물도서</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col_8 col_md_12">
                            <div class="sel_box sel_full">
                                <select id="searchKind3" name="searchKind3" title="분류" class="placeholder">
                                    <option value="">전체</option>
                                    <option value="J" <c:if test="${searchKind3 eq 'J'}">selected="selected"</c:if>>인성심리</option>
                        ...
                        <div class="col_8 col_md_24 pl_20 pl_md_0 line_md_top">
                            <div class="sel_box sel_full">
                                <select id="searchKind4" name="searchKind4" title="신청상태" class="placeholder">
                                    <option value="">전체</option>
                                    <option value="A" <c:if test="${searchKind4 eq 'A'}">selected="selected"</c:if>>신청대기</option>
                                    <option value="P" <c:if test="${searchKind4 eq 'P'}">selected="selected"</c:if>>신청조율</option>
                                    <option value="O" <c:if test="${searchKind4 eq 'O'}">selected="selected"</c:if>>열람확정</option>
                                    <option value="C" <c:if test="${searchKind4 eq 'C'}">selected="selected"</c:if>>신청취소</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row_24 mt_10">
                        <div class="col_5 col_md_6 pr_20">
                            <div class="sel_box sel_full">
                                <select id="searchVal2" name="searchVal2" title="기간" class="placeholder">
                                    <option value="">기간 선택</option>
                                    <option value="ALL" <c:if test="${searchVal2 eq 'ALL'}">selected="selected"</c:if>>전체</option>
                                    <option value="1" <c:if test="${searchVal2 eq '1'}">selected="selected"</c:if>>신청일</option>
                                    <option value="2" <c:if test="${searchVal2 eq '2'}">selected="selected"</c:if>>열람일시</option>
                                    <option value="3" <c:if test="${searchVal2 eq '3'}">selected="selected"</c:if>>확정일시</option>
                                    <!--2020.11.04 :s-->
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col_10 col_md_24 pl_20 pl_md_0 line_md_top">
                            <div class="data_search_word_box">
                                <div class="fm_inp inp_full">
                                    <input class="inp" name="searchVal" id="searchVal" value="${searchVal}" title="검색어" placeholder="인물도서 제목 또는 인물도서로 검색하세요.">
                                </div>
                    ...
                    <ul>
                        <li class="t_head fs_20">
                            <section class="table">
                                ...
                                <div class="col wid_150">신청경로</div>
                                <div class="col wid_100">분류</div>
                                <div class="col">인물도서 제목</div>
                                <div class="col wid_150">인물도서</div>
                                <div class="col wid_150">열람일시</div>
                                <div class="col wid_150">확정일시</div>
                        ...
                        <c:if test="${fn:length(itemList) == 0}">
                            <li class="_moInit noDate">
                                <div class="t_center">
                                    ...
                                    <p  class="mt_30 fs_30"><span class="fw_600">‘열람 신청’</span> 에 대한 검색결과가 없습니다.</p>
                                </div>
                            </li>
                        </c:if>
                        ...
                        <c:forEach items="${itemList}" var="item" varStatus="status">
                            ...
                            <li class="wa_ba">
                                <a href="/ssem/senior/mypage/person_book_insert.do?person_book_apy_idx=${item.person_book_apy_idx}">
                                    <section class="table">
                                        ...
                                        <div class="col wid_150">
                                            <c:choose>
                                                <c:when test="${item.gubun eq 'N'}">인물도서</c:when>
                                                <c:when test="${item.gubun eq 'S'}">찾아가는 인물도서</c:when>
                                        ...
                                        <div class="col"><p class="ellip_1">${item.title}</p></div>
                                        <div class="col wid_150">${item.person}</div>
                                        <div class="col wid_150">${fn:substring(item.view_dt, 0, 10)}</div>
                                        <div class="col wid_150">${fn:substring(item.confirm_dt, 0, 10)}</div>
                                        <div class="col wid_150">${fn:substring(item.reg_dt, 0, 10)}</div>
                                        <div class="col wid_100">
                                            <c:choose>
                                                <c:when test="${item.status eq 'A'}"><span class="my_tc_2">신청대기</span></c:when>
                                                <c:when test="${item.status eq 'P'}"><span class="my_tc_4">신청조율</span></c:when>
                                                <c:when test="${item.status eq 'O'}"><span class="my_tc_1">열람확정</span></c:when>
