    ...
    <div class="sub_con st_5 mypage_st"><!-- sub_con -->
        ...
        <section class="text_con fs_20 fs_md_26 pb_100 mb_15 mt_50">
            <div class="wrap">
                ...
                <form name="frm_cancel" id="frm_cancel" action="/ssem/senior/mypage/instrum_donation_cancel.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="instrum_dnt_idx" value="${instrumDntVo.instrum_dnt_idx}" />
                </form>
                <form name="frm" id="frm" action="/ssem/senior/mypage/instrum_donation_insert.do" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="instrum_dnt_idx" value="${instrumDntVo.instrum_dnt_idx}" />
                ...
                <div class="table_box fs_18 fs_md_24"><!--table_box-->
                    <table class="table">
                        <caption class="text_hide">신청 정보폼의 기증상태, 악기명, 악기유형, 악기구입년도, 사진등록, 신청일</caption>
                        <tbody>
                        <tr>
                        ...
                        <c:choose>
                            <c:when test="${instrumDntVo.status eq 'A'}">
                                ...
                                <div class="col_3 t_right">
                                    <a href="/ssem/senior/mypage/instrum_donation_list.do" class="btn btn_short btn_big ml_md_10">목록</a>
                                </div>
                            </c:when>
                            <c:otherwise>
                                <div class="t_right">
