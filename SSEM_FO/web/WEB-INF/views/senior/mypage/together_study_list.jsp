...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5 mypage_st"><!-- sub_con -->
        ...
        <div class="data_search ptb_30 fs_20 fs_md_26"><!--Data Search-->
            <form name="frm" id="frm" method="post" action="/ssem/senior/mypage/together_study_list.do">
                ...
                <div class="table_img_ul st_2 fs_18 mt_15"> <!--table_img_ul-->
                    <ul>
                        ...
                        <c:forEach items="${itemList}" var="item" varStatus="status">
                            ...
                            <li>
                                <a href="/ssem/senior/mypage/together_study_insert.do?join_study_idx=${item.join_study_idx}">
                                    <section class="row">
