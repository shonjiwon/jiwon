...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <form name="frm" id="frm" method="post" action="/ssem/senior/forever/club_news_list.do">
                ...
                <div class="row">
                    <div class="col_2 col_md_12 pl_30 pl_md_0 col_half t_md_right">
                        <div class="sel_box sel_full sel_md_short">
                            <select id="searchKind" name="searchKind" title="전체" class="placeholder">
                    ...
                    <div class="col_10 col_md_12 pl_20 pr_30 pl_md_0 pr_md_0  mt_md_25">
                        <div class="data_search_word_box">
                            <div class="fm_inp inp_full">
                                <input class="inp" id="searchVal" name="searchVal" title="검색어" value="${searchVal}">
                            </div>
                ...
                <div class="img_list_box row mt_25 mt_md_30 pt_10">
                    <c:if test="${fn:length(itemList) == 0}">
                        <div class="img_list_item color_1 col_12">
                            ...
                            <div class="noDate t_center">
                                ...
                                <p  class="mt_30 fs_30"><span class="fw_600">‘활동소식’</span> 에 대한 검색결과가 없습니다.</p>
                            </div>
                            <!--data : e-->
                        </div>
                    </c:if>
                    <c:forEach items="${itemList}" var="item" varStatus="status">
                        <div class="img_list_item color_1 col_3 col_lg_4 col_sm_6">
                            <a href="/ssem/senior/forever/club_news_view.do?club_news_idx=${item.club_news_idx}">
                                <section>
                                    <div class="img_box">
                                        <c:choose>
                                            <c:when test="${fn:length(item.thumbFileList) == 0}">
                                                    <img src="/ssem/resources/img/sub/335x225.jpg" alt="송파쌤이미지">
                                            </c:when>
                                            <c:otherwise>
                                    ...
                                    <div class="text_box">
                                        ...
                                        <div class="item_bottom">
                                            <div class="clearfix">
                                                <span class="float_left fw_200"><span class="fw_500 tc_b mr_10">작성일 </span>  ${fn:substring(item.reg_dt, 0, 10)}</span>
                                            </div>
                                        </div>
                                    </div>
                                </section>
