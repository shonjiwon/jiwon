...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btn_insert").click(function(){
            modalMsg("법률상담 상세 내용을 등록하시겠습니까?", 'yesorno', insert_frm);
        });
    });
...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <form name="frm" id="frm" action="/ssem/senior/lawtax/law_counsel_inscr.do" method="post" enctype="multipart/form-data">
