...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn_insert').click(function(){
            modalMsg("운영준비 중입니다.<br> 상담 게시글 등록 시 현재는 답변이 어려우며<br>정식 운영시 안내해 드리겠습니다.", 'locurl', "/ssem/senior/lawtax/tax_counsel_inscr.do");
        });
    });
</script>
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <div class="data_search ptb_30 fs_20 fs_md_26 fs_md_24 mt_60"><!--Data Search-->
            <form name="frm" id="frm" method="post" action="/ssem/senior/lawtax/tax_counsel_list.do">
                <input type="hidden" name="page" id="page" value="${page}"/>
                <input type="hidden" name="searchKind2" id="searchKind2" value="T"/>
            ...
            <div class="table_list_ul mt_10 fs_18 fs_lg_16 fs_md_24" id="moTable"> <!--table_list_ul-->
                <ul>
                        ...
                        <li>
                            <section>
                                ...
                                <div class="noDate t_center">
                                    ...
                                    <p  class="mt_30 fs_30"><span class="fw_600">‘세무상담’</span> 에 대한 검색결과가 없습니다.</p>
                                </div>
                                <!--data : e-->
                            </section>
                        </li>
                    ...
                    <c:forEach items="${itemList}" var="item" varStatus="status">
                        ...
                        <li class="wa_ba">
                            <a href="/ssem/senior/lawtax/tax_counsel_view.do?lawtax_idx=${item.lawtax_idx}">
                                <section class="table">
