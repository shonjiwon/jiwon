...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#btn_update").click(function(){
            modalMsg("세무상담 상세 내용을 수정하시겠습니까?", 'yesorno', update_frm);
        });

        $("#btn_delete").click(function(){
            modalMsg("세무상담 내용을 삭제하시겠습니까?", 'yesorno', delete_frm);
        });
    });
...
<div class="contents" id="contents">
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <form name="frm_del" id="frm_del" action="/ssem/senior/lawtax/tax_counsel_delete.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="lawtax_idx" value="${lawtaxCounselVo.lawtax_idx}"/>
        </form>

        <form name="frm" id="frm" action="/ssem/senior/lawtax/tax_counsel_view.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="lawtax_idx" value="${lawtaxCounselVo.lawtax_idx}"/>
            ...
            <section class="text_con wrap fs_20 fs_md_26  pb_100 mb_15">
                ...
                <div class="agree_box mt_60 fs_18 fs_md_24"><!--agree_box-->
                    ...
                    <ul class="ul_list_dot mb_20 tc_sub fw_300">
                        <li>개인정보의 수집 및 이용 목적 : 세금문의의 신청내용 확인 및 답변, 필요시 관리</li>
