...
<div class="contents" id="contents">
                ...
                <ul class="deapth_cnt2">
                    ...
                    <li class="deapth_1">
                        ...
                        <ul>
                            ...
                            <li><a href="/ssem/senior/lawtax/law_counsel_list.do">온라인 코칭쌤</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- location_nav // -->
    ...
    <div class="sub_con st_5"><!-- sub_con -->
        ...
        <div class="data_search ptb_30 fs_20  fs_md_26 fs_md_24"><!--Data Search-->
            <form name="frm" id="frm" method="post" action="/ssem/senior/coach/coach_list.do">
            ...
            <div class="row">
                <div class="coach_info_box">
                    ...
                    <div class="dp_inb ml_30 mt_55 va_t m_coach_text">
                        ...
                        <p class="t_bef_middot c1 fs_20">질문대기방 운영시간 : <span class="fw_600" style="color:#1fb593;">상단 운영시간 참고</span> (주말과 공휴일은 미운영)</p>
                            ...
                            <a href="#none">
                                <section class="table_2">
                                    ...
                                    <div class="col wid_10 t_right screen_md_hide" style="padding-right: 0 !important;">
                                        <span><i class="icon_time_blue_se">시간</i></span>
                                    </div>
